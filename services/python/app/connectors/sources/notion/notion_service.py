...
class NotionService:
    ...
    def __init__(self, integration_secret = None, org_id: str = None, workspace_id:str = None, logger=None, arango_service=None, kafka_service=None, config_service=None):
    ...
    async def fetch_and_create_notion_records(self, batch_size: int = 50) -> AsyncGenerator[Dict[str, Any], None]:
        ...
        try:
            ...
            self.logger.error(f"Error in fetching and creating notion records: {str(e)}")
            yield {
                "step": "error",
                "status": "failed",
