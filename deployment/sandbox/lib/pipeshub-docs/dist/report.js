import { AlignmentType, BorderStyle, Document, Footer, Header, HeadingLevel, ImageRun, LevelFormat, Packer, PageBreak, PageNumber, PageOrientation, Paragraph, ShadingType, Table, TableCell, TableOfContents, TableRow, TextRun, WidthType, } from "docx";
...
export class Report {
    ...
    tableOfContents() {
        ...
        this.children.push(new TableOfContents("Table of Contents", {
            hyperlink: true,
    ...
    table(options) {
        ...
        const widths = options.columnWidths && options.columnWidths.length === cols
        ...
        const headerRow = new TableRow({
            tableHeader: true,
            children: options.headers.map((h, i) => new TableCell({
        ...
        const dataRows = options.rows.map((row, r) => new TableRow({
        ...
        this.children.push(new Paragraph({ spacing: { after: 180 }, children: [new TextRun("")] }));
        return this;
    }
    image(options) {
        const palette = this.theme.palette;
            ...
            sections: [
                {
                    properties: {
                        page: {
                            size: {
                                ...
                                orientation: this.opts.orientation === "landscape"
                    ...
                    headers: this.opts.headerText
                        ...
                        : undefined,
                    footers: (this.opts.showFooterPageNumbers ?? true)
                        ? {
                            default: new Footer({
                                children: [
                                    new Paragraph({
