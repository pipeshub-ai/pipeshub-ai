...
import { Box, Button, Dialog, Flex, IconButton, Text, Badge } from '@radix-ui/themes';
...
/**
 * User-scoped toolset auth (workspace “my toolsets”), matching pipeshub ToolsetConfigDialog MANAGE mode:
 * OAuth popup, non-OAuth credential fields, reauthenticate, remove.
 */
          ...
          {isOAuthType(authType) ? (
            <Flex direction="column" gap="3">
              ...
              <Flex gap="2" wrap="wrap">
                ...
                {isAuthenticated ? (
                  <Button variant="soft" color="gray" onClick={() => void handleReauthenticate()} disabled={busy}>
