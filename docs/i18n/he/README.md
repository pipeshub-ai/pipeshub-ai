...
ממשק Next.js, API ב-Node.js ושירותי Python למחברים, אינדוקס ושאילתות. ברירת המחדל של המתקין היא Neo4j, Qdrant, MongoDB, Kafka ו-Redis. ראו את [סקירת המערכת](https://docs.pipeshub.com/system-overview).
