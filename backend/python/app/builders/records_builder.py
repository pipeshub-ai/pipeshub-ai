...
class RecordBuilder:
    ...
    def with_timestamps(
        self, created: float = None, updated: float = None
    ) -> "RecordBuilder":
    ...
    def with_source_timestamps(
        self, created: float = None, modified: float = None
    ) -> "RecordBuilder":
    ...
    def with_last_extraction_timestamp(
        self, last_extraction_timestamp: float
    ) -> "RecordBuilder":
...
class MailRecordBuilder:
    ...
    def with_dates(
        self, internal_date: str = None, date: str = None
    ) -> "MailRecordBuilder":
        if internal_date:
