...
class OneNote:
    ...
    def get_notebooks(self, top: int | None = None) -> tuple[bool, str]:
        ...
        try:
            ...
            response = self._run_async(
                self.client.me_onenote_get_notebooks(
    ...
    def get_sections(self, notebook_id: str) -> tuple[bool, str]:
        ...
        try:
            ...
            response = self._run_async(
                self.client.me_onenote_notebooks_get_sections(
                    notebook_id=notebook_id,
    ...
    def get_pages(self, notebook_id: str, section_id: str) -> tuple[bool, str]:
        ...
        try:
            ...
            response = self._run_async(
                self.client.me_onenote_notebooks_sections_get_pages(
                    notebook_id=notebook_id,
    ...
    def get_page(self, page_id: str) -> tuple[bool, str]:
        ...
        try:
            ...
            logger.error(
                "Get page not implemented - add a pages.by_onenote_page_id GET wrapper in data source"
            )
    ...
    def create_page(
        ...
        try:
            ...
            response = self._run_async(
                self.client.me_onenote_notebooks_sections_create_pages(
                    notebook_id=notebook_id,
                    onenoteSection_id=section_id,
    ...
    def update_page(
        ...
        try:
            ...
            logger.error(
                "Update page not implemented - requires onenote_patch_content path; add wrapper in data source"
            )
            return False, json.dumps(
                {
    ...
    def delete_page(
        self, notebook_id: str, section_id: str, page_id: str
    ) -> tuple[bool, str]:
        ...
        try:
            ...
            response = self._run_async(
                self.client.me_onenote_notebooks_sections_delete_pages(
                    notebook_id=notebook_id,
                    onenoteSection_id=section_id,
