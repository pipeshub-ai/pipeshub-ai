...
class FreshDesk:
    ...
    def get_ticket(
        self, ticket_id: int, include: str | None = None
    ) -> tuple[bool, str]:
        try:
            response = self._run_async(
                self.client.get_ticket(id=ticket_id, include=include)
            )
    ...
    @tool(
        ...
        parameters=[
            ...
            ToolParameter(
                name="occasional",
                type=ParameterType.BOOLEAN,
                description="True if occasional agent",
                required=False,
            ),
            ToolParameter(
                name="job_title",
            ...
            ToolParameter(
                name="department_ids",
                type=ParameterType.ARRAY,
                description="IDs of departments (array of numbers)",
                required=False,
            ),
            ToolParameter(
                name="can_see_all_tickets_from_associated_departments",
                type=ParameterType.BOOLEAN,
                description="Can view all department tickets",
                required=False,
            ),
            ToolParameter(
                name="reporting_manager_id",
                type=ParameterType.NUMBER,
                description="User ID of reporting manager",
                required=False,
            ),
            ToolParameter(
                name="address",
            ...
            ToolParameter(
                ...
                type=ParameterType.NUMBER,
                description="Scoreboard level ID",
                required=False,
            ),
            ToolParameter(
                name="roles",
            ...
            ToolParameter(
                name="signature",
                type=ParameterType.STRING,
                description="Signature in HTML format",
                required=False,
            ),
            ToolParameter(
                name="custom_fields",
            ...
            ToolParameter(
                name="workspace_ids",
                type=ParameterType.ARRAY,
                description="Workspace IDs (array of numbers)",
                required=False,
            ),
        ],
    ...
    def search_tickets(
        ...
        try:
            ...
            return self._handle_response(
                response, "Ticket search completed successfully"
            )
        except Exception as e:
