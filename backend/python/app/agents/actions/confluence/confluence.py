...
class Confluence:
    ...
    def create_page(self, space_id: str, page_title: str, page_content: str) -> Tuple[bool, str]:
        try:
            ...
            if response.status in [HttpStatusCode.SUCCESS, HttpStatusCode.CREATED]:
    ...
    def update_page_title(self, page_id: str, new_title: str) -> Tuple[bool, str]:
        try:
            ...
            if response.status in [HttpStatusCode.SUCCESS, HttpStatusCode.NO_CONTENT]:
                result_data = response.json() if response.status == HttpStatusCode.SUCCESS else {}
