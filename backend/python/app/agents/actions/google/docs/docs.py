...
class GoogleDocs:
    ...
    def get_document(
        ...
        try:
            ...
            document = self._run_async(
                self.client.documents_get(
    ...
    def batch_update_document(
        ...
        try:
            ...
            result = self._run_async(
                self.client.documents_batch_update(
                    documentId=document_id,
                    requests=requests,
            ...
            return True, json.dumps(
                {
                    ...
                    "old_text": old_text,
                    "new_text": new_text,
                    "occurrences_changed": result.get("replies", [{}])[0]
                    .get("replaceAllText", {})
