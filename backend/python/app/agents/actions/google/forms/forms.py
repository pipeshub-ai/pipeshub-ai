...
class GoogleForms:
    ...
    def create_form(
        ...
        try:
            ...
            form = self._run_async(
                self.client.forms_create(
                    body=form_data,
                )
            )
    ...
    def batch_update_form(
        ...
        try:
            ...
            result = self._run_async(
                self.client.forms_batch_update(
                    formId=form_id,
    ...
    def get_form_responses(
        ...
        try:
            ...
            responses = self._run_async(
                self.client.forms_responses_list(
                    formId=form_id,
                    filter=filter,
                    pageSize=page_size,
    ...
    def get_form_response(
        ...
        try:
            ...
            response = self._run_async(
                self.client.forms_responses_get(
                    formId=form_id,
    ...
    def set_publish_settings(
        ...
        try:
            ...
            # Use GoogleFormsDataSource method
            result = self._run_async(
                self.client.forms_set_publish_settings(
                    formId=form_id,
                    body=settings_data,
                )
            )
    ...
    def create_watch(
        ...
        try:
            ...
            # Use GoogleFormsDataSource method
            watch = self._run_async(
                self.client.forms_watches_create(
                    formId=form_id,
                    body=watch_data,
                )
            )
