    ...
    def _filter_files_by_size(self, files: list, size_condition: str) -> list:
        ...
        try:
            ...
            for file in files:
                ...
                if (operator == "=" and file_size == value) or (operator == ">" and file_size > value) or (operator == ">=" and file_size >= value) or (operator == "<" and file_size < value) or (operator == "<=" and file_size <= value):
