...
class Slack:
        ...
        try:
            ...
            if isinstance(response, dict):
                if response.get("ok") is False:
                    return SlackResponse(
                        success=False, error=response.get("error", "unknown_error")
                    )
                ...
                if isinstance(chan, str):
                    ...
                    if not name.startswith("C"):
                        ...
                        if (
                            cl_resp.success
                            and cl_resp.data
                            and isinstance(cl_resp.data, dict)
                        ):
    ...
    def get_channel_members(self, channel: str) -> tuple[bool, str]:
        ...
        try:
            # Use SlackDataSource method
            response = self._run_async(
                self.client.conversations_members(channel=channel)
            )
            slack_response = self._handle_slack_response(response)
            return (slack_response.success, slack_response.to_json())
        except Exception as e:
    ...
    def get_channel_members_by_id(self, channel_id: str) -> tuple[bool, str]:
        ...
        try:
            # Use SlackDataSource method
            response = self._run_async(
                self.client.conversations_members(channel=channel_id)
            )
            slack_response = self._handle_slack_response(response)
            return (slack_response.success, slack_response.to_json())
        except Exception as e:
        ...
        try:
            ...
            if not user_id:
                return (
                    False,
                    SlackResponse(
                        success=False, error=f"User '{user}' not found"
                    ).to_json(),
                )
            ...
            channel_id = (
                slack_response.data.get("channel", {}).get("id")
            ...
            if not channel_id:
                return (
                    False,
                    SlackResponse(
                        success=False, error="Failed to get DM channel ID"
                    ).to_json(),
                )

            # Send message to DM channel
            message_response = self._run_async(
    ...
    def send_message_with_formatting(
    ...
    def reply_to_message(
        ...
        try:
            ...
            if latest_message and not thread_ts:
                history_response = self._run_async(
                    self.client.conversations_history(channel=channel, limit=1)
                )
                history_slack_response = self._handle_slack_response(history_response)

                if (
                    not history_slack_response.success
                    or not history_slack_response.data
                ):
                    return (
                        False,
                        SlackResponse(
                            success=False, error="Failed to get latest message"
                        ).to_json(),
                    )
                ...
                if not messages:
                    return (
                        False,
                        SlackResponse(
                            success=False, error="No messages found in channel"
                        ).to_json(),
                    )
            ...
            if not thread_ts:
                return (
                    False,
                    SlackResponse(
                        success=False, error="No thread timestamp provided"
                    ).to_json(),
                )
    ...
    def send_message_to_multiple_channels(
        self, channels: list[str], message: str
    ) -> tuple[bool, str]:
        ...
        try:
            ...
            return (
                all_success,
                SlackResponse(success=all_success, data={"results": results}).to_json(),
            )
        ...
        try:
            ...
            if slack_response.success and slack_response.data:
                ...
                if purpose and channel_id:
                    try:
                        self._run_async(
                            self.client.conversations_set_purpose(
        ...
        try:
            ...
            if not user_ids:
                return (
                    False,
                    SlackResponse(
                        success=False, error="No valid users found to invite"
                    ).to_json(),
                )
    ...
    def schedule_message(
        self, channel: str, message: str, post_at: str
    ) -> tuple[bool, str]:
        ...
        try:
            response = self._run_async(
                self.client.chat_schedule_message(
                    channel=channel,
                    text=message,
                    post_at=int(post_at),
                )
    ...
    def create_poll(
        self, channel: str, question: str, options: list[str]
    ) -> tuple[bool, str]:
    ...
    def archive_channel(self, channel: str) -> tuple[bool, str]:
        ...
        try:
            response = self._run_async(
                self.client.conversations_archive(channel=channel)
            )
            slack_response = self._handle_slack_response(response)
            return (slack_response.success, slack_response.to_json())
        except Exception as e:
    ...
    def get_unread_messages(self, channel: str) -> tuple[bool, str]:
        ...
        try:
            ...
            # Get recent messages
            history_response = self._run_async(
                self.client.conversations_history(channel=channel, limit=50)
            )
            history_slack_response = self._handle_slack_response(history_response)

            if not history_slack_response.success:
                return (
                    history_slack_response.success,
                    history_slack_response.to_json(),
                )

            # Combine channel info with recent messages
            result = {
                "channel_info": info_slack_response.data,
                "recent_messages": history_slack_response.data.get("messages", [])
                if history_slack_response.data
                else [],
            }
    ...
    def get_scheduled_messages(self, channel: str | None = None) -> tuple[bool, str]:
        ...
        try:
            ...
            response = self._run_async(
                self.client.chat_scheduled_messages_list(**kwargs)
            )
            slack_response = self._handle_slack_response(response)
            return (slack_response.success, slack_response.to_json())
        except Exception as e:
    ...
    def send_message_with_mentions(
        self, channel: str, message: str, mentions: list[str] | None = None
    ) -> tuple[bool, str]:
    ...
    def get_users_list(
        self, include_deleted: bool | None = None, limit: int | None = None
    ) -> tuple[bool, str]:
    ...
    def get_user_groups(
        self, include_users: bool | None = None, include_disabled: bool | None = None
    ) -> tuple[bool, str]:
    ...
    def get_user_group_info(
        self, usergroup: str, include_disabled: bool | None = None
    ) -> tuple[bool, str]:
    ...
    def get_user_channels(
        self, user: str, exclude_archived: bool | None = None, types: str | None = None
    ) -> tuple[bool, str]:
    ...
    def delete_message(
        self, channel: str, timestamp: str, as_user: bool | None = None
    ) -> tuple[bool, str]:
    ...
    def get_message_permalink(self, channel: str, timestamp: str) -> tuple[bool, str]:
        ...
        try:
            response = self._run_async(
                self.client.chat_get_permalink(
                    channel=channel,
    ...
    def get_reactions(
        self, channel: str, timestamp: str, full: bool | None = None
    ) -> tuple[bool, str]:
    ...
    def mark_channel_read(
        self, channel: str, timestamp: str | None = None
    ) -> tuple[bool, str]:
    ...
    def get_thread_replies(
        self, channel: str, timestamp: str, limit: int | None = None
    ) -> tuple[bool, str]:
    ...
    def _resolve_user_identifier(self, user_identifier: str) -> str | None:
        ...
        try:
            ...
            if "@" in user_identifier:
                try:
                    response = self._run_async(
                        self.client.users_lookup_by_email(email=user_identifier)
                    )
                    slack_response = self._handle_slack_response(response)
                    if slack_response.success and slack_response.data:
            ...
            try:
                ...
                while True:
                    ...
                    users_response = self._run_async(
                        self.client.users_list(cursor=cursor, limit=1000)
                    )
                    users_slack_response = self._handle_slack_response(users_response)

                    if (
                        not users_slack_response.success
                        or not users_slack_response.data
                    ):
                        break
                    ...
                    for user in users:
                        ...
                        for name in names_to_match:
                            if (
                                isinstance(name, str)
                                and name.casefold() == target_identifier
                            ):
                                # Early return when match is found
                                return user.get("id")

                    # Check for next page
                    response_metadata = users_slack_response.data.get(
                        "response_metadata", {}
                    )
