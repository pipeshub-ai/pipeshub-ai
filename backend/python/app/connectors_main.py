...
async def resume_sync_services(app_container: ConnectorAppContainer, data_store: GraphDataStore = None) -> bool:
    ...
    try:
        ...
        for org in orgs:
            ...
            # Edition hook: OSS returns global config + shared store;
            # EE returns org-scoped ConfigurationServiceEE + GraphDataStore.
...
# EE: wire org-scoped KnowledgeHubService without touching the OSS router.
