...
class RegistryToolWrapper(BaseTool):
    ...
    def __init__(self, app_name: str, tool_name: str, registry_tool, state: ChatState, **kwargs):
    ...
    def _execute_tool_directly(self, arguments: dict):
    ...
    def _create_tool_instance(self, action_class):
        ...
        try:
            ...
            if self.app_name == "slack":
                ...
                from app.agents.actions.jira.config import JiraTokenConfig, JiraApiKeyConfig, JiraUsernamePasswordConfig
                ...
                from app.agents.actions.confluence.config import ConfluenceTokenConfig, ConfluenceApiKeyConfig, ConfluenceUsernamePasswordConfig
...
def get_tool_by_name(tool_name: str, state: ChatState):
