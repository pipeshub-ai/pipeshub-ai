...
class WriteToFileInput(BaseModel):
    ...
    filename: str | None = Field(default=None, description="Optional filename, will use default if not provided")
...
class WebSearchInput(BaseModel):
    ...
    max_results: int | None = Field(default=5, description="Maximum number of search results to return (default: 5)")
...
class WriteToFileTool(BaseTool):
    ...
    def _run(self, content: str, filename: str | None = None, append: bool = False) -> str:
