...
class DocumentExtraction(Transformer):
    ...
    async def extract_metadata(
        ...
        is_multimodal_llm = config["isMultimodal"]
        try:
            ...
            filled_prompt = prompt_for_blocks_extraction.replace(
    ...
    async def process_document(self, blocks: List[Block], org_id: str) -> DocumentClassification:
            self.logger.info("🖼️ Processing bloc for semantic metadata extraction")
