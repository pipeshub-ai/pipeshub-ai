                ...
                try:
                    ...
                    return [
                        VectorPoint(
                            ...
                            dense_vector=embedding,
                            payload=vector_point_payload(
                                image_chunks[batch_start + i].get("metadata", {}),
                                image_chunks[batch_start + i].get("image_uri", ""),
                            ),
                        )
        ...
        async def embed_single(i: int, image_ref: str) -> Optional[VectorPoint]:
            ...
            try:
                ...
                return VectorPoint(
                    ...
                    payload=vector_point_payload(
                        image_chunks[i].get("metadata", {}),
                        image_chunks[i].get("image_uri", ""),
                    ),
                )
                ...
                try:
                    ...
                    return [
                        VectorPoint(
                            ...
                            payload=vector_point_payload(
                                image_chunks[valid[i][0]].get("metadata", {}),
                                image_chunks[valid[i][0]].get("image_uri", ""),
                            ),
                        )
