...
class VLMOCRStrategy(OCRStrategy):
    ...
    async def load_document(self, content: bytes) -> None:
        ...
        self.logger.debug("📄 Initial VLM OCR load")
        ...
        if needs_ocr:
            self.logger.info("🤖 Document needs OCR, processing with vlm")
            ...
            raise Exception("VLM OCR is not needed as ocr was not needed")
