...
class BaseSyncTasks:
    ...
    def register_connector_sync_control(
        ...
        def manual_sync_control_task(action: str, org_id: str) -> dict[str, Any]:
            ...
            try:
                ...
                self.logger.error(
                    f"Error in manual sync control for {connector_name}: {e!s}"
                )
        ...
        for org in orgs:
            ...
            for user in users:
                ...
                try:
                    ...
                    self.logger.error(
                        f"Failed to renew watches for user {email}: {e!s}"
                    )
                    continue
    ...
    def get_connector_task(self, connector_name: str) -> Callable | None:
