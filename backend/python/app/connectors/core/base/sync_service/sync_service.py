...
class BaseSyncService(ISyncService, ABC):
    ...
    async def initialize(self, org_id: str, sync_config: dict[str, Any] | None = None) -> bool:
    ...
    async def start_sync(self, org_id: str, sync_config: dict[str, Any] | None = None) -> bool:
    ...
    async def get_sync_progress(self, org_id: str, sync_id: str | None = None) -> SyncProgress:
        """Get sync progress"""
        try:
