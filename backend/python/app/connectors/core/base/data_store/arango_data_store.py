...
class ArangoTransactionStore(TransactionStore):
    ...
    async def get_records_by_status(self, org_id: str, connector_name: Connectors, status_filters: list[str], limit: int | None = None, offset: int = 0) -> list[Record]:
    ...
    async def get_app_role_by_external_id(self, connector_name: Connectors, external_id: str) -> AppRole | None:
