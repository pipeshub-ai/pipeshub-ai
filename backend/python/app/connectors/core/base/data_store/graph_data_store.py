...
class GraphTransactionStore(TransactionStore):
    ...
    async def get_record_by_path(self, connector_id: str, path: str,record_group_name:str) -> Optional[Record]:
        return await self.graph_provider.get_record_by_path(connector_id, path,record_group_name, transaction=self.txn)
