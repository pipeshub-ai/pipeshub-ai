...
TokenRefreshService / ToolsetTokenRefreshService are edition-switched via
app.edition_services (flip together with app.edition_config).
"""
...
class StartupService:
    ...
    async def initialize(
        ...
        ``oauth_config_resolver`` is used by EE multi-tenant refresh services;
        OSS ignores it when None.
        """
...
# Global startup service instance (single singleton for OSS and EE)
