...
class NoOpRateLimiter(IRateLimiter):
    ...
    async def acquire(self, operation: str = "default") -> bool:
        ...
        """
        self.logger.debug(
            f"No-op rate limiter: token acquired for operation '{operation}'"
        )
        return True
    ...
    async def release(self, operation: str = "default") -> None:
        ...
        """
        self.logger.debug(
            f"No-op rate limiter: token released for operation '{operation}'"
        )
    ...
    async def reset(self, operation: str = "default") -> None:
        ...
        """
        self.logger.debug(
            f"No-op rate limiter: reset called for operation '{operation}'"
        )
