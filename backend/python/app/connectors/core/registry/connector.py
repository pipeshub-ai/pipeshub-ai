...
@(
    ...
    .configure(
        lambda builder: builder.with_icon("/assets/icons/connectors/drive.svg")
...
@(
    ...
    .configure(
        lambda builder: builder.with_icon("/assets/icons/connectors/gmail.svg")
        .with_realtime_support(True)
        .add_documentation_link(
            DocumentationLink(
                "Gmail API Setup",
        ...
        .add_auth_field(CommonFields.client_secret("Google Cloud Console"))
        .with_webhook_config(
            True, ["message.created", "message.modified", "message.deleted"]
        )
        .with_sync_strategies(["SCHEDULED", "MANUAL"])
        .with_scheduled_config(True, 60)
        .add_filter_field(
...
@(
    ...
    .configure(
        lambda builder: builder.with_icon("/assets/icons/connectors/slack.svg")
        .add_documentation_link(
            DocumentationLink(
        ...
        .with_scheduled_config(True, 60)
        .add_filter_field(
            CommonFields.channels_filter(), "https://slack.com/api/conversations.list"
        ),
    )
    .build_decorator()
)
...
@(
    ...
    .with_categories(["Messaging"])
    .configure(
        lambda builder: builder.with_icon("/assets/icons/connectors/notion.svg")
        .add_documentation_link(
            DocumentationLink(
...
@(
    ...
    .configure(
        lambda builder: builder.with_icon("/assets/icons/connectors/calendar.svg")
        .with_realtime_support(True)
        .add_documentation_link(
            DocumentationLink(
                "Calendar API Setup",
...
@(
    ...
    .configure(
        lambda builder: builder.with_icon("/assets/icons/connectors/meet.svg")
        .with_realtime_support(True)
        .add_documentation_link(
            DocumentationLink(
                "Meet API Setup",
...
@(
    ...
    .configure(
        lambda builder: builder.with_icon("/assets/icons/connectors/docs.svg")
        .with_realtime_support(True)
        .add_documentation_link(
            DocumentationLink(
                "Docs API Setup",
        ...
        .add_auth_field(CommonFields.client_secret("Google Cloud Console"))
        .with_webhook_config(
            True, ["document.created", "document.modified", "document.deleted"]
        )
        .with_sync_strategies(["SCHEDULED", "MANUAL"])
        .with_scheduled_config(True, 60),
    )
...
@(
    ...
    .configure(
        lambda builder: builder.with_icon("/assets/icons/connectors/sheets.svg")
        .with_realtime_support(True)
        .add_documentation_link(
            DocumentationLink(
                "Sheets API Setup",
...
@(
    ...
    .configure(
        lambda builder: builder.with_icon("/assets/icons/connectors/forms.svg")
        .with_realtime_support(True)
        .add_documentation_link(
            DocumentationLink(
                "Forms API Setup",
...
@(
    ...
    .configure(
        lambda builder: builder.with_icon("/assets/icons/connectors/slides.svg")
        .with_realtime_support(True)
        .add_documentation_link(
            DocumentationLink(
                "Slides API Setup",
...
@(
    ...
    .configure(
        lambda builder: builder.with_icon("/assets/icons/connectors/airtable.svg")
        .add_documentation_link(
            DocumentationLink(
...
@(
    ...
    .with_categories(["Storage"])
    .configure(
        lambda builder: builder.with_icon("/assets/icons/connectors/azureblob.svg")
        .add_documentation_link(
            DocumentationLink(
...
@(
    ...
    .configure(
        lambda builder: builder.with_icon("/assets/icons/connectors/linear.svg")
        .add_documentation_link(
            DocumentationLink(
...
@(
    ...
    .with_categories(["Storage"])
    .configure(
        lambda builder: builder.with_icon("/assets/icons/connectors/s3.svg")
        .add_documentation_link(
            DocumentationLink(
                "S3 Access Key Setup",
...
@(
    ...
    .with_categories(["Issue Tracking"])
    .configure(
        lambda builder: builder.with_icon("/assets/icons/connectors/servicenow.svg")
        .add_documentation_link(
            DocumentationLink(
...
@(
    ...
    .with_categories(["Issue Tracking"])
    .configure(
        lambda builder: builder.with_icon("/assets/icons/connectors/zendesk.svg")
        .add_documentation_link(
            DocumentationLink(
