#!/usr/bin/env python3
"""
Test script for the Docling service client (not part of pytest suite).
"""
...
pytestmark = pytest.mark.skip(reason="Standalone script; excluded from pytest test collection")
