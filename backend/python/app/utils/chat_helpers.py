...
async def get_flattened_results(result_set: List[Dict[str, Any]], blob_store: BlobStorage, org_id: str, is_multimodal_llm: bool, virtual_record_id_to_result: Dict[str, Dict[str, Any]],from_tool: bool = False) -> List[Dict[str, Any]]:
    flattened_results = []
    seen_chunks = set()
    adjacent_chunks = {}
    new_type_results = []
