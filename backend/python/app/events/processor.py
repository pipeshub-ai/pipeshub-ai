...
class Processor:
    ...
    # async def process_google_slides(self, record_id, record_version, orgId, content, virtual_record_id) -> AsyncGenerator[Dict[str, Any], None]:
    #     """Process Google Slides presentation, yielding phase completion events.
    ...
    # async def process_google_docs(self, record_id, record_version, orgId, content, virtual_record_id) -> AsyncGenerator[Dict[str, Any], None]:
    ...
    # async def process_google_sheets(self, record_id, record_version, orgId, content, virtual_record_id) -> AsyncGenerator[Dict[str, Any], None]:
