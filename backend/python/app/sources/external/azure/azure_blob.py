...
class AzureBlobDataSource:
    ...
    def _build_headers(self, custom_headers: dict[str, str] | None = None, **kwargs) -> dict[str, str]:
    ...
    async def generate_account_sas_url(
        ...
        **kwargs,
        ...
        try:
            ...
            return AzureBlobResponse(success=False, error=f"SAS generation failed: {e!s}")
    ...
    async def generate_container_sas_url(
        ...
        **kwargs,
        ...
        try:
            ...
            return AzureBlobResponse(success=False, error=f"Container SAS generation failed: {e!s}")
    ...
    async def generate_blob_sas_url(
        ...
        **kwargs,
        ...
        try:
            ...
            return AzureBlobResponse(success=False, error=f"Blob SAS generation failed: {e!s}")
    ...
    async def generate_user_delegation_sas_url(
        ...
        **kwargs,
        ...
        try:
            ...
            return AzureBlobResponse(success=False, error=f"User delegation SAS generation failed: {e!s}")
