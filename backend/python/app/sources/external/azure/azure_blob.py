...
class AzureBlobDataSource:
    ...
    async def _get_async_blob_service_client(self) -> AsyncBlobServiceClient:
        ...
        if self._async_blob_service_client is None:
            self._async_blob_service_client = (
                await self._azure_blob_client_wrapper.get_async_blob_service_client()
            )
        return self._async_blob_service_client

    def _build_headers(
        self, custom_headers: dict[str, str] | None = None, **kwargs
    ) -> dict[str, str]:
    ...
    async def create_container(
        ...
        timeout: int | None = None,
        meta: str | None = None,
        blob_public_access: str | None = None,
        client_request_id: str | None = None,
        default_encryption_scope: str | None = None,
        deny_encryption_scope_override: bool | None = None,
        headers: dict[str, str] | None = None,
        **kwargs,
    ) -> AzureBlobResponse:
    ...
    async def restore_container(
        ...
        timeout: int | None = None,
        client_request_id: str | None = None,
        deleted_container_name: str | None = None,
        deleted_container_version: str | None = None,
        headers: dict[str, str] | None = None,
        **kwargs,
    ) -> AzureBlobResponse:
    ...
    async def break_container_lease(
        ...
        container_name: str,
        timeout: int | None = None,
        lease_break_period: int | None = None,
        If_Modified_Since: datetime | None = None,
        If_Unmodified_Since: datetime | None = None,
        client_request_id: str | None = None,
        headers: dict[str, str] | None = None,
    ...
    async def download_blob(
        ...
        range: str | None = None,
        lease_id: str | None = None,
        range_get_content_md5: bool | None = None,
        range_get_content_crc64: bool | None = None,
    ...
    async def delete_blob(
        ...
        timeout: int | None = None,
        lease_id: str | None = None,
        delete_snapshots: str | None = None,
        If_Modified_Since: datetime | None = None,
        If_Unmodified_Since: datetime | None = None,
        If_Match: str | None = None,
        If_None_Match: str | None = None,
    ...
    async def create_page_blob(
        ...
        blob_content_encoding: str | None = None,
        blob_content_language: str | None = None,
        blob_content_md5: bytes | None = None,
        blob_cache_control: str | None = None,
        meta: str | None = None,
        lease_id: str | None = None,
        blob_content_disposition: str | None = None,
        encryption_key: str | None = None,
        encryption_key_sha256: str | None = None,
        encryption_algorithm: str | None = None,
        ...
        If_None_Match: str | None = None,
        if_tags: str | None = None,
        blob_sequence_number: int | None = 0,
        client_request_id: str | None = None,
        tags: str | None = None,
        immutability_policy_until_date: datetime | None = None,
    ...
    async def upload_blob(
        ...
        immutability_policy_mode: str | None = None,
        legal_hold: bool | None = None,
        content_crc64: bytes | None = None,
        structured_body: str | None = None,
        structured_content_length: int | None = None,
        headers: dict[str, str] | None = None,
        **kwargs,
    ) -> AzureBlobResponse:
    ...
    async def put_block_blob_from_url(
        ...
        If_None_Match: str | None = None,
        if_tags: str | None = None,
        source_if_modified_since: datetime | None = None,
        source_if_unmodified_since: datetime | None = None,
        source_if_match: str | None = None,
        source_if_none_match: str | None = None,
        source_if_tags: str | None = None,
        client_request_id: str | None = None,
        source_content_md5: bytes | None = None,
        tags: str | None = None,
        copy_source_blob_properties: bool | None = None,
        copy_source_authorization: str | None = None,
        copy_source_tag_option: str | None = None,
        file_request_intent: str | None = None,
        headers: dict[str, str] | None = None,
        **kwargs,
    ) -> AzureBlobResponse:
    ...
    async def start_copy_blob_from_url(
        ...
        meta: str | None = None,
        access_tier: str | None = None,
        rehydrate_priority: str | None = None,
        source_if_modified_since: datetime | None = None,
        source_if_unmodified_since: datetime | None = None,
        source_if_match: str | None = None,
        source_if_none_match: str | None = None,
    ...
    async def stage_block_from_url(
        ...
        source_content_md5: bytes | None = None,
        source_content_crc64: bytes | None = None,
        timeout: int | None = None,
        encryption_key: str | None = None,
        encryption_key_sha256: str | None = None,
        encryption_algorithm: str | None = None,
    ...
    async def upload_pages(
        ...
        encryption_algorithm: str | None = None,
        encryption_scope: str | None = None,
        if_sequence_number_le: int | None = None,
        if_sequence_number_lt: int | None = None,
        if_sequence_number_eq: int | None = None,
        If_Modified_Since: datetime | None = None,
        If_Unmodified_Since: datetime | None = None,
        If_Match: str | None = None,
        If_None_Match: str | None = None,
    ...
    async def append_block(
        ...
        content_crc64: bytes | None = None,
        lease_id: str | None = None,
        blob_condition_maxsize: int | None = None,
        blob_condition_appendpos: int | None = None,
        encryption_key: str | None = None,
        encryption_key_sha256: str | None = None,
        encryption_algorithm: str | None = None,
        encryption_scope: str | None = None,
    ...
    async def generate_account_sas_url(
        ...
        **kwargs,
        ...
        try:
            ...
            account_key = (
                client.credential.account_key
                if hasattr(client.credential, "account_key")
                else None
            )
            ...
            return AzureBlobResponse(
                success=False, error=f"SAS generation failed: {e!s}"
            )
    ...
    async def generate_container_sas_url(
        ...
        **kwargs,
        ...
        try:
            ...
            return AzureBlobResponse(
                success=False, error=f"Container SAS generation failed: {e!s}"
            )
    ...
    async def generate_blob_sas_url(
        ...
        **kwargs,
        ...
        try:
            ...
            return AzureBlobResponse(
                success=False, error=f"Blob SAS generation failed: {e!s}"
            )
        ...
        try:
            ...
            if isinstance(user_delegation_key, dict):
                try:
                    ...
                    delegation_key.signed_service = user_delegation_key[
                        "signed_service"
                    ]
                    delegation_key.signed_version = user_delegation_key[
                        "signed_version"
                    ]
                    ...
                    return AzureBlobResponse(
                        success=False,
                        error=f"User delegation key dictionary is missing required key: {e}",
                    )
            else:
            ...
            return AzureBlobResponse(
                success=False, error=f"User delegation SAS generation failed: {e!s}"
            )
