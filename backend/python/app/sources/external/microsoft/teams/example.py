...
async def main():
    ...
    response: TeamsResponse = await teams_data_source.users_get_teamwork(
    ...
    response: TeamsResponse = await teams_data_source.users_create_chats(
        user_id=user_id_or_upn, body=chat
    )  # fix the body
    print(response.data)
    print(response.error)
    print(response.success)
