...
class TeamsDataSource:
        ...
        try:
            if response is None:
                return TeamsResponse(
                    success=False, error="Empty response from Teams API"
                )
    ...
    async def teams_team_get_team(
        ...
        try:
            ...
            response = await self.client.teams.by_team_id(team_id).get(
    ...
    async def teams_team_update_team(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Update team
    ...
    async def teams_get_group(
        ...
        try:
            ...
            response = await self.client.teams.by_team_id(team_id).group.get(
                request_configuration=config
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_create_installed_apps(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Add app to team
        ...
        """
        try:
            response = await self.client.teams.by_team_id(team_id).installed_apps.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_delete_installed_apps(
        ...
        try:
            response = (
                ...
                .installed_apps.by_installed_app_id(teamsAppInstallation_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_get_installed_apps(
        self,
        team_id: str,
    ...
    async def teams_update_installed_apps(
        self,
        team_id: str,
        teamsAppInstallation_id: str,
    ...
    async def teams_installed_apps_get_teams_app(
        self,
        team_id: str,
        teamsAppInstallation_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            response = (
                await self.client.teams.by_team_id(team_id)
                .installed_apps.by_installed_app_id(teamsAppInstallation_id)
                .teams_app.get(request_configuration=config)
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_installed_apps_get_teams_app_definition(
        self,
        team_id: str,
        teamsAppInstallation_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            response = (
                await self.client.teams.by_team_id(team_id)
                .installed_apps.by_installed_app_id(teamsAppInstallation_id)
                .teams_app_definition.get(request_configuration=config)
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_team_installed_apps_teams_app_installation_upgrade(
        self,
        team_id: str,
        teamsAppInstallation_id: str,
        body: dict[str, Any] | None = None,
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .installed_apps.by_installed_app_id(teamsAppInstallation_id)
                .upgrade.post(body=body)
            )
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in teams_team_installed_apps_teams_app_installation_upgrade: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teams_create_operations(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        """
        try:
            response = await self.client.teams.by_team_id(team_id).operations.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_delete_operations(
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .operations.by_operation_id(teamsAsyncOperation_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_get_operations(
        self,
        team_id: str,
    ...
    async def teams_update_operations(
        self,
        team_id: str,
        teamsAsyncOperation_id: str,
        body: dict[str, Any] | None = None,
    ...
    async def teams_get_photo(
        ...
        try:
            ...
            response = await self.client.teams.by_team_id(team_id).photo.get(
                request_configuration=config
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_delete_primary_channel(self, team_id: str) -> TeamsResponse:
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).primary_channel.delete()
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in teams_delete_primary_channel: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def teams_get_primary_channel(
        self,
        team_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            response = await self.client.teams.by_team_id(team_id).primary_channel.get(
                request_configuration=config
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_update_primary_channel(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).primary_channel.patch(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in teams_update_primary_channel: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def teams_primary_channel_create_all_members(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).primary_channel.all_members.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in teams_primary_channel_create_all_members: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def teams_team_primary_channel_all_members_add(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).primary_channel.all_members.add.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in teams_team_primary_channel_all_members_add: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def teams_team_primary_channel_all_members_remove(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).primary_channel.all_members.remove.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in teams_team_primary_channel_all_members_remove: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def teams_primary_channel_delete_all_members(
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .primary_channel.all_members.by_allMember_id(conversationMember_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_primary_channel_update_all_members(
        self,
        team_id: str,
    ...
    async def teams_primary_channel_create_members(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).primary_channel.members.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in teams_primary_channel_create_members: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def teams_team_primary_channel_members_add(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).primary_channel.members.add.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in teams_team_primary_channel_members_add: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def teams_team_primary_channel_members_remove(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).primary_channel.members.remove.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in teams_team_primary_channel_members_remove: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def teams_primary_channel_delete_members(
        self, team_id: str, conversationMember_id: str
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .primary_channel.members.by_membership_id(conversationMember_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_primary_channel_get_members(
        self,
        team_id: str,
        conversationMember_id: str,
        select: list[str] | None = None,
    ...
    async def teams_primary_channel_update_members(
        self,
        team_id: str,
        conversationMember_id: str,
        body: dict[str, Any] | None = None,
    ...
    async def teams_team_primary_channel_provision_email(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).primary_channel.provision_email.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in teams_team_primary_channel_provision_email: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def teams_team_primary_channel_remove_email(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).primary_channel.remove_email.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_get_schedule(
        ...
        try:
            ...
            response = await self.client.teams.by_team_id(team_id).schedule.get(
                request_configuration=config
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_set_schedule(
        ...
        """
        try:
            response = await self.client.teams.by_team_id(team_id).schedule.put(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_schedule_create_day_notes(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).schedule.day_notes.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in teams_schedule_create_day_notes: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def teams_schedule_delete_day_notes(
        self, team_id: str, dayNote_id: str
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .schedule.day_notes.by_dayNote_id(dayNote_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_schedule_get_day_notes(
        self,
        team_id: str,
        dayNote_id: str,
        select: list[str] | None = None,
    ...
    async def teams_schedule_update_day_notes(
        self, team_id: str, dayNote_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def teams_schedule_create_offer_shift_requests(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).schedule.offer_shift_requests.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in teams_schedule_create_offer_shift_requests: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def teams_schedule_delete_offer_shift_requests(
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .schedule.offer_shift_requests.by_offerShiftRequest_id(
                    offerShiftRequest_id
                )
                .delete()
            )
            return self._handle_teams_response(response)
    ...
    async def teams_schedule_get_offer_shift_requests(
        self,
        team_id: str,
    ...
    async def teams_schedule_update_offer_shift_requests(
        self,
        team_id: str,
        offerShiftRequest_id: str,
        body: dict[str, Any] | None = None,
    ...
    async def teams_schedule_create_open_shift_change_requests(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).schedule.open_shift_change_requests.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in teams_schedule_create_open_shift_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teams_schedule_delete_open_shift_change_requests(
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .schedule.open_shift_change_requests.by_openShiftChangeRequest_id(
                    openShiftChangeRequest_id
                )
                .delete()
            )
            return self._handle_teams_response(response)
            ...
            logger.error(
                f"Error in teams_schedule_delete_open_shift_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teams_schedule_get_open_shift_change_requests(
        self,
        team_id: str,
    ...
    async def teams_schedule_update_open_shift_change_requests(
        self,
        team_id: str,
        openShiftChangeRequest_id: str,
        body: dict[str, Any] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in teams_schedule_update_open_shift_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teams_schedule_create_open_shifts(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create openShift
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).schedule.open_shifts.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in teams_schedule_create_open_shifts: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def teams_schedule_delete_open_shifts(
        self, team_id: str, openShift_id: str
    ) -> TeamsResponse:
        """Delete openShift
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .schedule.open_shifts.by_openShift_id(openShift_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_schedule_get_open_shifts(
        self,
        team_id: str,
        openShift_id: str,
        select: list[str] | None = None,
    ...
    async def teams_schedule_update_open_shifts(
        self, team_id: str, openShift_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Update openShift
    ...
    async def teams_schedule_create_scheduling_groups(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).schedule.scheduling_groups.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in teams_schedule_create_scheduling_groups: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def teams_schedule_delete_scheduling_groups(
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .schedule.scheduling_groups.by_schedulingGroup_id(schedulingGroup_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_schedule_get_scheduling_groups(
        self,
        team_id: str,
    ...
    async def teams_schedule_update_scheduling_groups(
        self, team_id: str, schedulingGroup_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def teams_schedule_create_shifts(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create shift
        ...
        """
        try:
            response = await self.client.teams.by_team_id(team_id).schedule.shifts.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_schedule_delete_shifts(
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .schedule.shifts.by_shift_id(shift_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_schedule_get_shifts(
        self,
        team_id: str,
        shift_id: str,
        select: list[str] | None = None,
    ...
    async def teams_schedule_update_shifts(
        self, team_id: str, shift_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Replace shift
    ...
    async def teams_schedule_create_swap_shifts_change_requests(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).schedule.swap_shifts_change_requests.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in teams_schedule_create_swap_shifts_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teams_schedule_delete_swap_shifts_change_requests(
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .schedule.swap_shifts_change_requests.by_swapShiftsChangeRequest_id(
                    swapShiftsChangeRequest_id
                )
                .delete()
            )
            return self._handle_teams_response(response)
            ...
            logger.error(
                f"Error in teams_schedule_delete_swap_shifts_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teams_schedule_get_swap_shifts_change_requests(
        self,
        team_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in teams_schedule_get_swap_shifts_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teams_schedule_update_swap_shifts_change_requests(
        self,
        team_id: str,
        swapShiftsChangeRequest_id: str,
        body: dict[str, Any] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in teams_schedule_update_swap_shifts_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teams_schedule_create_time_cards(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create timeCard
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).schedule.time_cards.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in teams_schedule_create_time_cards: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def teams_team_schedule_time_cards_clock_in(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).schedule.time_cards.clock_in.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in teams_team_schedule_time_cards_clock_in: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def teams_schedule_delete_time_cards(
        self, team_id: str, timeCard_id: str
    ) -> TeamsResponse:
        """Delete timeCard
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .schedule.time_cards.by_timeCard_id(timeCard_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_schedule_get_time_cards(
        self,
        team_id: str,
        timeCard_id: str,
        select: list[str] | None = None,
    ...
    async def teams_schedule_update_time_cards(
        self, team_id: str, timeCard_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def teams_team_schedule_time_cards_time_card_clock_out(
        self, team_id: str, timeCard_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .schedule.time_cards.by_timeCard_id(timeCard_id)
                .clock_out.post(body=body)
            )
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in teams_team_schedule_time_cards_time_card_clock_out: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teams_team_schedule_time_cards_time_card_confirm(
        self, team_id: str, timeCard_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .schedule.time_cards.by_timeCard_id(timeCard_id)
                .confirm.post(body=body)
            )
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in teams_team_schedule_time_cards_time_card_confirm: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teams_team_schedule_time_cards_time_card_end_break(
        self, team_id: str, timeCard_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .schedule.time_cards.by_timeCard_id(timeCard_id)
                .end_break.post(body=body)
            )
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in teams_team_schedule_time_cards_time_card_end_break: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teams_team_schedule_time_cards_time_card_start_break(
        self, team_id: str, timeCard_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .schedule.time_cards.by_timeCard_id(timeCard_id)
                .start_break.post(body=body)
            )
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in teams_team_schedule_time_cards_time_card_start_break: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teams_schedule_create_time_off_reasons(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).schedule.time_off_reasons.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in teams_schedule_create_time_off_reasons: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def teams_schedule_delete_time_off_reasons(
        self, team_id: str, timeOffReason_id: str
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .schedule.time_off_reasons.by_timeOffReason_id(timeOffReason_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_schedule_get_time_off_reasons(
        self,
        team_id: str,
    ...
    async def teams_schedule_update_time_off_reasons(
        self, team_id: str, timeOffReason_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def teams_schedule_create_time_off_requests(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).schedule.time_off_requests.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in teams_schedule_create_time_off_requests: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def teams_schedule_delete_time_off_requests(
        self, team_id: str, timeOffRequest_id: str
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .schedule.time_off_requests.by_timeOffRequest_id(timeOffRequest_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_schedule_get_time_off_requests(
        self,
        team_id: str,
    ...
    async def teams_schedule_update_time_off_requests(
        self, team_id: str, timeOffRequest_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def teams_schedule_create_times_off(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create timeOff
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).schedule.times_off.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in teams_schedule_create_times_off: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def teams_schedule_delete_times_off(
        self, team_id: str, timeOff_id: str
    ) -> TeamsResponse:
        """Delete timeOff
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .schedule.times_off.by_timesOff_id(timeOff_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_schedule_get_times_off(
        self,
        team_id: str,
        timeOff_id: str,
        select: list[str] | None = None,
    ...
    async def teams_schedule_update_times_off(
        self, team_id: str, timeOff_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Replace timeOff
    ...
    async def teams_team_send_activity_notification(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.teams.by_team_id(
                team_id
            ).send_activity_notification.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in teams_team_send_activity_notification: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def teams_create_tags(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create teamworkTag
    ...
    async def teams_delete_tags(
        self, team_id: str, teamworkTag_id: str
    ) -> TeamsResponse:
        """Delete teamworkTag
    ...
    async def teams_update_tags(
        self, team_id: str, teamworkTag_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Update teamworkTag
    ...
    async def teams_tags_create_members(
        self, team_id: str, teamworkTag_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def teams_tags_delete_members(
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .tags.by_tag_id(teamworkTag_id)
                .members.by_membership_id(teamworkTagMember_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_tags_get_members(
        self,
        team_id: str,
        teamworkTag_id: str,
    ...
    async def teams_tags_update_members(
        self,
        team_id: str,
        teamworkTag_id: str,
        teamworkTagMember_id: str,
    ...
    async def teams_get_template(
        ...
        try:
            ...
            response = await self.client.teams.by_team_id(team_id).template.get(
                request_configuration=config
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_create_channels(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create channel
        ...
        """
        try:
            response = await self.client.teams.by_team_id(team_id).channels.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_delete_channels(
    ...
    async def teams_update_channels(
        self, team_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Patch channel
    ...
    async def teams_channels_create_all_members(
        self, team_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create new navigation property to allMembers for teams
    ...
    async def teams_team_channels_channel_all_members_add(
        self, team_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .channels.by_channel_id(channel_id)
                .all_members.add.post(body=body)
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_team_channels_channel_all_members_remove(
        self, team_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .channels.by_channel_id(channel_id)
                .all_members.remove.post(body=body)
            )
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in teams_team_channels_channel_all_members_remove: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teams_channels_delete_all_members(
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .channels.by_channel_id(channel_id)
                .all_members.by_allMember_id(conversationMember_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_channels_update_all_members(
        self,
        team_id: str,
        channel_id: str,
        conversationMember_id: str,
    ...
    async def teams_channels_create_members(
        self, team_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def teams_team_channels_channel_members_add(
        self, team_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
    ...
    async def teams_team_channels_channel_members_remove(
        self, team_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
    ...
    async def teams_channels_get_members(
        self,
        team_id: str,
        channel_id: str,
        conversationMember_id: str,
        ...
        try:
            ...
            response = (
                await self.client.teams.by_team_id(team_id)
                .channels.by_channel_id(channel_id)
                .members.by_membership_id(conversationMember_id)
                .get(request_configuration=config)
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_channels_update_members(
        self,
        team_id: str,
        channel_id: str,
        conversationMember_id: str,
    ...
    async def teams_team_channels_channel_provision_email(
        self, team_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action provisionEmail
        ...
        try:
            response = (
                await self.client.teams.by_team_id(team_id)
                .channels.by_channel_id(channel_id)
                .provision_email.post(body=body)
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_team_channels_channel_remove_email(
        self, team_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action removeEmail
    ...
    async def teams_channels_create_tabs(
        self, team_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Add tab to channel
    ...
    async def teams_channels_delete_tabs(
    ...
    async def teams_channels_get_tabs(
        self,
        team_id: str,
        channel_id: str,
        teamsTab_id: str,
    ...
    async def chats_chat_hide_for_user(self, chat_id: str, body: Chat) -> TeamsResponse:
        ...
        """
        try:
            response = await self.client.chats.by_chat_id(chat_id).hide_for_user.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def chats_create_installed_apps(
        self, chat_id: str, body: Chat
    ) -> TeamsResponse:
        """Add app to chat
        ...
        """
        try:
            response = await self.client.chats.by_chat_id(chat_id).installed_apps.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def chats_delete_installed_apps(
    ...
    async def chats_get_installed_apps(
        self,
        chat_id: str,
        teamsAppInstallation_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            if skip:
                query_params.skip = skip
            config = ChatsRequestBuilder.ChatsRequestBuilderGetRequestConfiguration(
                query_parameters=query_params
            )
            response = (
                await self.client.chats.by_chat_id(chat_id)
    ...
    async def chats_update_installed_apps(
        self, chat_id: str, teamsAppInstallation_id: str, body: Chat
    ) -> TeamsResponse:
    ...
    async def chats_installed_apps_get_teams_app(
        self,
        chat_id: str,
        teamsAppInstallation_id: str,
        select: list[str] | None = None,
    ...
    async def chats_installed_apps_get_teams_app_definition(
        self,
        chat_id: str,
        teamsAppInstallation_id: str,
        select: list[str] | None = None,
    ...
    async def chats_chat_installed_apps_teams_app_installation_upgrade(
        self, chat_id: str, teamsAppInstallation_id: str, body: Chat
    ) -> TeamsResponse:
        """Invoke action upgrade
        ...
        try:
            ...
            logger.error(
                f"Error in chats_chat_installed_apps_teams_app_installation_upgrade: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def chats_chat_mark_chat_read_for_user(
        self, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        """
        try:
            response = await self.client.chats.by_chat_id(
                chat_id
            ).mark_chat_read_for_user.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in chats_chat_mark_chat_read_for_user: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def chats_chat_mark_chat_unread_for_user(
        self, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.chats.by_chat_id(
                chat_id
            ).mark_chat_unread_for_user.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in chats_chat_mark_chat_unread_for_user: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def chats_create_members(
        self, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        """
        try:
            response = await self.client.chats.by_chat_id(chat_id).members.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def chats_chat_members_add(
        self, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
        ...
        """
        try:
            response = await self.client.chats.by_chat_id(chat_id).members.add.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def chats_chat_members_remove(
        self, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
        ...
        """
        try:
            response = await self.client.chats.by_chat_id(chat_id).members.remove.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def chats_delete_members(
    ...
    async def chats_update_members(
        self,
        chat_id: str,
        conversationMember_id: str,
        body: dict[str, Any] | None = None,
    ...
    async def chats_chat_send_activity_notification(
        self, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action sendActivityNotification
    ...
    async def chats_chat_unhide_for_user(
        self, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        """
        try:
            response = await self.client.chats.by_chat_id(chat_id).unhide_for_user.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def me_get_chats(
        ...
        try:
            ...
            response = await self.client.me.chats.by_chat_id(chat_id).get(
                request_configuration=config
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def me_chats_chat_hide_for_user(
        self, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action hideForUser
        ...
        """
        try:
            response = await self.client.me.chats.by_chat_id(
                chat_id
            ).hide_for_user.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in me_chats_chat_hide_for_user: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def me_chats_create_installed_apps(
        self, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.me.chats.by_chat_id(
                chat_id
            ).installed_apps.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in me_chats_create_installed_apps: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def me_chats_delete_installed_apps(
        self, chat_id: str, teamsAppInstallation_id: str
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.me.chats.by_chat_id(chat_id)
                .installed_apps.by_installed_app_id(teamsAppInstallation_id)
                .delete()
            )
            return self._handle_teams_response(response)
    ...
    async def me_chats_get_installed_apps(
        self,
        chat_id: str,
        teamsAppInstallation_id: str,
        select: list[str] | None = None,
    ...
    async def me_chats_update_installed_apps(
        self,
        chat_id: str,
        teamsAppInstallation_id: str,
        body: dict[str, Any] | None = None,
    ...
    async def me_chats_installed_apps_get_teams_app(
        self,
        chat_id: str,
        teamsAppInstallation_id: str,
        select: list[str] | None = None,
    ...
    async def me_chats_installed_apps_get_teams_app_definition(
        self,
        chat_id: str,
        teamsAppInstallation_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in me_chats_installed_apps_get_teams_app_definition: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_chats_chat_installed_apps_teams_app_installation_upgrade(
        self,
        chat_id: str,
        teamsAppInstallation_id: str,
        body: dict[str, Any] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in me_chats_chat_installed_apps_teams_app_installation_upgrade: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_chats_chat_mark_chat_read_for_user(
        self, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action markChatReadForUser
    ...
    async def me_chats_chat_mark_chat_unread_for_user(
        self, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action markChatUnreadForUser
    ...
    async def me_chats_create_members(
        self, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        """
        try:
            response = await self.client.me.chats.by_chat_id(chat_id).members.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def me_chats_chat_members_add(
        self, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
        ...
        """
        try:
            response = await self.client.me.chats.by_chat_id(chat_id).members.add.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def me_chats_chat_members_remove(
        self, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
    ...
    async def me_chats_delete_members(
        self, chat_id: str, conversationMember_id: str
    ) -> TeamsResponse:
    ...
    async def me_chats_get_members(
        self,
        chat_id: str,
        conversationMember_id: str,
        select: list[str] | None = None,
    ...
    async def me_chats_update_members(
        self,
        chat_id: str,
        conversationMember_id: str,
        body: dict[str, Any] | None = None,
    ...
    async def me_chats_chat_send_activity_notification(
        self, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action sendActivityNotification
    ...
    async def me_chats_create_tabs(
        self, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        """
        try:
            response = await self.client.me.chats.by_chat_id(chat_id).tabs.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def me_chats_delete_tabs(
        self, chat_id: str, teamsTab_id: str
    ) -> TeamsResponse:
    ...
    async def me_chats_update_tabs(
        self, chat_id: str, teamsTab_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_chats_chat_unhide_for_user(
        self, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action unhideForUser
        ...
        try:
            response = await self.client.me.chats.by_chat_id(
                chat_id
            ).unhide_for_user.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def users_update_chats(
        self, user_id: str, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def users_user_chats_chat_hide_for_user(
        self, user_id: str, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action hideForUser
    ...
    async def users_chats_create_installed_apps(
        self, user_id: str, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def users_chats_delete_installed_apps(
    ...
    async def users_chats_get_installed_apps(
        self,
        user_id: str,
        chat_id: str,
        teamsAppInstallation_id: str,
    ...
    async def users_chats_update_installed_apps(
        self,
        user_id: str,
        chat_id: str,
        teamsAppInstallation_id: str,
    ...
    async def users_chats_installed_apps_get_teams_app(
        self,
        user_id: str,
        chat_id: str,
        teamsAppInstallation_id: str,
    ...
    async def users_chats_installed_apps_get_teams_app_definition(
        self,
        user_id: str,
        chat_id: str,
        teamsAppInstallation_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_chats_installed_apps_get_teams_app_definition: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_user_chats_chat_installed_apps_teams_app_installation_upgrade(
        self,
        user_id: str,
        chat_id: str,
        teamsAppInstallation_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_chats_chat_installed_apps_teams_app_installation_upgrade: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_user_chats_chat_mark_chat_read_for_user(
        self, user_id: str, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action markChatReadForUser
    ...
    async def users_user_chats_chat_mark_chat_unread_for_user(
        self, user_id: str, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action markChatUnreadForUser
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_chats_chat_mark_chat_unread_for_user: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_chats_create_members(
        self, user_id: str, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def users_user_chats_chat_members_add(
        self, user_id: str, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
    ...
    async def users_user_chats_chat_members_remove(
        self, user_id: str, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
    ...
    async def users_chats_delete_members(
    ...
    async def users_chats_get_members(
        self,
        user_id: str,
        chat_id: str,
        conversationMember_id: str,
    ...
    async def users_chats_update_members(
        self,
        user_id: str,
        chat_id: str,
        conversationMember_id: str,
    ...
    async def users_user_chats_chat_send_activity_notification(
        self, user_id: str, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action sendActivityNotification
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_chats_chat_send_activity_notification: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_chats_create_tabs(
        self, user_id: str, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def users_chats_delete_tabs(
        self, user_id: str, chat_id: str, teamsTab_id: str
    ) -> TeamsResponse:
    ...
    async def users_chats_get_tabs(
        self,
        user_id: str,
        chat_id: str,
        teamsTab_id: str,
    ...
    async def users_chats_update_tabs(
        self,
        user_id: str,
        chat_id: str,
        teamsTab_id: str,
    ...
    async def users_user_chats_chat_unhide_for_user(
        self, user_id: str, chat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action unhideForUser
    ...
    async def teams_create_members(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Add member to team
        ...
        """
        try:
            response = await self.client.teams.by_team_id(team_id).members.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_team_members_add(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
        ...
        """
        try:
            response = await self.client.teams.by_team_id(team_id).members.add.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_team_members_remove(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
        ...
        """
        try:
            response = await self.client.teams.by_team_id(team_id).members.remove.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teams_delete_members(
        self, team_id: str, conversationMember_id: str
    ) -> TeamsResponse:
    ...
    async def teams_update_members(
        self,
        team_id: str,
        conversationMember_id: str,
        body: dict[str, Any] | None = None,
    ...
    async def groups_team_channels_create_tabs(
        self, group_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def groups_team_channels_delete_tabs(
        self, group_id: str, channel_id: str, teamsTab_id: str
    ) -> TeamsResponse:
    ...
    async def groups_team_channels_get_tabs(
        self,
        group_id: str,
        channel_id: str,
        teamsTab_id: str,
    ...
    async def groups_team_channels_update_tabs(
        self,
        group_id: str,
        channel_id: str,
        teamsTab_id: str,
    ...
    async def groups_team_primary_channel_create_tabs(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create new navigation property to tabs for groups
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.primary_channel.tabs.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in groups_team_primary_channel_create_tabs: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_primary_channel_delete_tabs(
        self, group_id: str, teamsTab_id: str
    ) -> TeamsResponse:
        """Delete navigation property tabs for groups
        ...
        try:
            response = (
                await self.client.groups.by_group_id(group_id)
                .team.primary_channel.tabs.by_tab_id(teamsTab_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_team_primary_channel_get_tabs(
        self,
        group_id: str,
        teamsTab_id: str,
        select: list[str] | None = None,
    ...
    async def groups_team_primary_channel_update_tabs(
        self, group_id: str, teamsTab_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Update the navigation property tabs in groups
    ...
    async def me_joined_teams_channels_create_tabs(
        self, team_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create new navigation property to tabs for me
    ...
    async def me_joined_teams_channels_delete_tabs(
        self, team_id: str, channel_id: str, teamsTab_id: str
    ) -> TeamsResponse:
        """Delete navigation property tabs for me
    ...
    async def me_joined_teams_channels_get_tabs(
        self,
        team_id: str,
        channel_id: str,
        teamsTab_id: str,
    ...
    async def me_joined_teams_channels_update_tabs(
        self,
        team_id: str,
        channel_id: str,
        teamsTab_id: str,
    ...
    async def me_joined_teams_primary_channel_create_tabs(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create new navigation property to tabs for me
        ...
        try:
            response = await self.client.me.joined_teams.by_joinedTeam_id(
                team_id
            ).primary_channel.tabs.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in me_joined_teams_primary_channel_create_tabs: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_primary_channel_delete_tabs(
        self, team_id: str, teamsTab_id: str
    ) -> TeamsResponse:
        """Delete navigation property tabs for me
        ...
        try:
            response = (
                await self.client.me.joined_teams.by_joinedTeam_id(team_id)
                .primary_channel.tabs.by_tab_id(teamsTab_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def me_joined_teams_primary_channel_get_tabs(
        self,
        team_id: str,
        teamsTab_id: str,
        select: list[str] | None = None,
    ...
    async def me_joined_teams_primary_channel_update_tabs(
        self, team_id: str, teamsTab_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Update the navigation property tabs in me
    ...
    async def teams_primary_channel_create_tabs(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def teams_primary_channel_delete_tabs(
        self, team_id: str, teamsTab_id: str
    ) -> TeamsResponse:
    ...
    async def teams_primary_channel_get_tabs(
        self,
        team_id: str,
        teamsTab_id: str,
        select: list[str] | None = None,
    ...
    async def teams_primary_channel_update_tabs(
        self, team_id: str, teamsTab_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def teamwork_deleted_teams_channels_create_tabs(
        self, deletedTeam_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def teamwork_deleted_teams_channels_delete_tabs(
    ...
    async def teamwork_deleted_teams_channels_get_tabs(
        self,
        deletedTeam_id: str,
        channel_id: str,
        teamsTab_id: str,
    ...
    async def teamwork_deleted_teams_channels_update_tabs(
        self,
        deletedTeam_id: str,
        channel_id: str,
        teamsTab_id: str,
    ...
    async def users_joined_teams_channels_create_tabs(
        self,
        user_id: str,
        team_id: str,
        channel_id: str,
    ...
    async def users_joined_teams_channels_delete_tabs(
    ...
    async def users_joined_teams_channels_get_tabs(
        self,
        user_id: str,
        team_id: str,
        channel_id: str,
    ...
    async def users_joined_teams_channels_update_tabs(
        self,
        user_id: str,
        team_id: str,
        channel_id: str,
    ...
    async def users_joined_teams_primary_channel_create_tabs(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create new navigation property to tabs for users
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_primary_channel_create_tabs: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_primary_channel_delete_tabs(
        self, user_id: str, team_id: str, teamsTab_id: str
    ) -> TeamsResponse:
        """Delete navigation property tabs for users
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_primary_channel_delete_tabs: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_primary_channel_get_tabs(
        self,
        user_id: str,
        team_id: str,
        teamsTab_id: str,
    ...
    async def users_joined_teams_primary_channel_update_tabs(
        self,
        user_id: str,
        team_id: str,
        teamsTab_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_primary_channel_update_tabs: {e}"
            )
            return TeamsResponse(success=False, error=str(e))
    ...
    async def me_teamwork_create_associated_teams(
        self, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_teamwork_delete_associated_teams(
        self, associatedTeamInfo_id: str
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.me.teamwork.associated_teams.by_associatedTeam_id(
                    associatedTeamInfo_id
                ).delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def me_teamwork_update_associated_teams(
        self, associatedTeamInfo_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_teamwork_associated_teams_get_team(
        self,
        ...
        try:
            ...
            response = (
                await self.client.me.teamwork.associated_teams.by_associatedTeam_id(
                    associatedTeamInfo_id
                ).team.get(request_configuration=config)
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def me_teamwork_create_installed_apps(
        self, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create new navigation property to installedApps for me
    ...
    async def me_teamwork_delete_installed_apps(
        self, userScopeTeamsAppInstallation_id: str
    ) -> TeamsResponse:
        """Delete navigation property installedApps for me
        ...
        """
        try:
            response = await self.client.me.teamwork.installed_apps.by_installed_app_id(
                userScopeTeamsAppInstallation_id
            ).delete()
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def me_teamwork_get_installed_apps(
        self,
    ...
    async def me_teamwork_update_installed_apps(
        self, userScopeTeamsAppInstallation_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Update the navigation property installedApps in me
    ...
    async def me_teamwork_installed_apps_get_chat(
        self,
        userScopeTeamsAppInstallation_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            response = await self.client.me.teamwork.installed_apps.by_installed_app_id(
                userScopeTeamsAppInstallation_id
            ).chat.get(request_configuration=config)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in me_teamwork_installed_apps_get_chat: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def me_teamwork_installed_apps_get_teams_app(
        self,
        userScopeTeamsAppInstallation_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
    ...
    async def me_teamwork_installed_apps_get_teams_app_definition(
        self,
        userScopeTeamsAppInstallation_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in me_teamwork_installed_apps_get_teams_app_definition: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_teamwork_send_activity_notification(
        self, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action sendActivityNotification
        ...
        """
        try:
            response = await self.client.me.teamwork.send_activity_notification.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teamwork_teamwork_get_teamwork(
        self,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        filter: str | None = None,
    ...
    async def teamwork_teamwork_update_teamwork(
        self, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Update teamwork
    ...
    async def teamwork_create_deleted_chats(
        self, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def teamwork_delete_deleted_chats(self, deletedChat_id: str) -> TeamsResponse:
        ...
        """
        try:
            response = await self.client.teamwork.deleted_chats.by_deletedChat_id(
                deletedChat_id
            ).delete()
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teamwork_get_deleted_chats(
        self,
        deletedChat_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
    ...
    async def teamwork_update_deleted_chats(
        self, deletedChat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def teamwork_deleted_chats_deleted_chat_undo_delete(
        self, deletedChat_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.teamwork.deleted_chats.by_deletedChat_id(
                deletedChat_id
            ).undo_delete.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in teamwork_deleted_chats_deleted_chat_undo_delete: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teamwork_create_deleted_teams(
        self, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def teamwork_delete_deleted_teams(self, deletedTeam_id: str) -> TeamsResponse:
        ...
        """
        try:
            response = await self.client.teamwork.deleted_teams.by_deletedTeam_id(
                deletedTeam_id
            ).delete()
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teamwork_get_deleted_teams(
        self,
        deletedTeam_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
    ...
    async def teamwork_update_deleted_teams(
        self, deletedTeam_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def teamwork_deleted_teams_create_channels(
        self, deletedTeam_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.teamwork.deleted_teams.by_deletedTeam_id(
                deletedTeam_id
            ).channels.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in teamwork_deleted_teams_create_channels: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def teamwork_deleted_teams_delete_channels(
    ...
    async def teamwork_deleted_teams_update_channels(
        self, deletedTeam_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def teamwork_deleted_teams_channels_create_all_members(
        self, deletedTeam_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in teamwork_deleted_teams_channels_create_all_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teamwork_deleted_teams_deleted_team_channels_channel_all_members_add(
        self, deletedTeam_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
        ...
        try:
            ...
            logger.error(
                f"Error in teamwork_deleted_teams_deleted_team_channels_channel_all_members_add: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teamwork_deleted_teams_deleted_team_channels_channel_all_members_remove(
        self, deletedTeam_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
        ...
        try:
            ...
            logger.error(
                f"Error in teamwork_deleted_teams_deleted_team_channels_channel_all_members_remove: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teamwork_deleted_teams_channels_delete_all_members(
        ...
        try:
            ...
            logger.error(
                f"Error in teamwork_deleted_teams_channels_delete_all_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teamwork_deleted_teams_channels_update_all_members(
        self,
        deletedTeam_id: str,
        channel_id: str,
        conversationMember_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in teamwork_deleted_teams_channels_update_all_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))
    ...
    async def teamwork_deleted_teams_channels_get_files_folder(
        ...
        try:
            ...
            logger.error(
                f"Error in teamwork_deleted_teams_channels_get_files_folder: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teamwork_deleted_teams_channels_create_members(
        self, deletedTeam_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in teamwork_deleted_teams_channels_create_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teamwork_deleted_teams_deleted_team_channels_channel_members_add(
        self, deletedTeam_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
        ...
        try:
            ...
            logger.error(
                f"Error in teamwork_deleted_teams_deleted_team_channels_channel_members_add: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teamwork_deleted_teams_deleted_team_channels_channel_members_remove(
        self, deletedTeam_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
        ...
        try:
            ...
            logger.error(
                f"Error in teamwork_deleted_teams_deleted_team_channels_channel_members_remove: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teamwork_deleted_teams_channels_delete_members(
        self, deletedTeam_id: str, channel_id: str, conversationMember_id: str
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in teamwork_deleted_teams_channels_delete_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teamwork_deleted_teams_channels_get_members(
        self,
        deletedTeam_id: str,
        channel_id: str,
        conversationMember_id: str,
    ...
    async def teamwork_deleted_teams_channels_update_members(
        self,
        deletedTeam_id: str,
        channel_id: str,
        conversationMember_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in teamwork_deleted_teams_channels_update_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teamwork_deleted_teams_deleted_team_channels_channel_provision_email(
        self, deletedTeam_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action provisionEmail
        ...
        try:
            ...
            logger.error(
                f"Error in teamwork_deleted_teams_deleted_team_channels_channel_provision_email: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teamwork_deleted_teams_deleted_team_channels_channel_remove_email(
        self, deletedTeam_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action removeEmail
        ...
        try:
            ...
            logger.error(
                f"Error in teamwork_deleted_teams_deleted_team_channels_channel_remove_email: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teamwork_send_activity_notification_to_recipients(
        self, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        """
        try:
            response = await self.client.teamwork.send_activity_notification_to_recipients.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in teamwork_send_activity_notification_to_recipients: {e}"
            )
            return TeamsResponse(success=False, error=str(e))
    ...
    async def teamwork_get_teams_app_settings(
        self,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        filter: str | None = None,
        ...
        try:
            ...
            response = await self.client.teamwork.teams_app_settings.get(
                request_configuration=config
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teamwork_update_teams_app_settings(
        self, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def teamwork_create_workforce_integrations(
        self, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def teamwork_delete_workforce_integrations(
        self, workforceIntegration_id: str
    ) -> TeamsResponse:
        ...
        """
        try:
            response = await self.client.teamwork.workforce_integrations.by_workforceIntegration_id(
                workforceIntegration_id
            ).delete()
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def teamwork_get_workforce_integrations(
        self,
    ...
    async def teamwork_update_workforce_integrations(
        self, workforceIntegration_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def users_get_teamwork(
        ...
        try:
            ...
            if skip:
                query_params.skip = skip
            config = RequestConfiguration(query_parameters=query_params)
            response = await self.client.users.by_user_id(user_id).teamwork.get(
                request_configuration=config
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def users_update_teamwork(
        ...
        """
        try:
            response = await self.client.users.by_user_id(user_id).teamwork.patch(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def users_teamwork_create_associated_teams(
        self, user_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.users.by_user_id(
                user_id
            ).teamwork.associated_teams.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in users_teamwork_create_associated_teams: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def users_teamwork_delete_associated_teams(
        self, user_id: str, associatedTeamInfo_id: str
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.users.by_user_id(user_id)
                .teamwork.associated_teams.by_associatedTeam_id(associatedTeamInfo_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def users_teamwork_update_associated_teams(
        self,
        user_id: str,
        associatedTeamInfo_id: str,
        body: dict[str, Any] | None = None,
    ...
    async def users_teamwork_associated_teams_get_team(
        self,
        user_id: str,
        associatedTeamInfo_id: str,
        select: list[str] | None = None,
    ...
    async def users_teamwork_create_installed_apps(
        self, user_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.users.by_user_id(
                user_id
            ).teamwork.installed_apps.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in users_teamwork_create_installed_apps: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def users_teamwork_delete_installed_apps(
        ...
        try:
            response = (
                await self.client.users.by_user_id(user_id)
                .teamwork.installed_apps.by_installed_app_id(
                    userScopeTeamsAppInstallation_id
                )
                .delete()
            )
    ...
    async def users_teamwork_get_installed_apps(
        self,
        user_id: str,
        userScopeTeamsAppInstallation_id: str,
        select: list[str] | None = None,
    ...
    async def users_teamwork_update_installed_apps(
        self,
        user_id: str,
        userScopeTeamsAppInstallation_id: str,
        body: dict[str, Any] | None = None,
    ...
    async def users_teamwork_installed_apps_get_chat(
        self,
        user_id: str,
        userScopeTeamsAppInstallation_id: str,
        select: list[str] | None = None,
    ...
    async def users_teamwork_installed_apps_get_teams_app(
        self,
        user_id: str,
        userScopeTeamsAppInstallation_id: str,
        select: list[str] | None = None,
    ...
    async def users_teamwork_installed_apps_get_teams_app_definition(
        self,
        user_id: str,
        userScopeTeamsAppInstallation_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in users_teamwork_installed_apps_get_teams_app_definition: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_user_teamwork_send_activity_notification(
        self, user_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action sendActivityNotification
        ...
        try:
            response = await self.client.users.by_user_id(
                user_id
            ).teamwork.send_activity_notification.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in users_user_teamwork_send_activity_notification: {e}"
            )
            return TeamsResponse(success=False, error=str(e))
    ...
    async def app_catalogs_delete_teams_apps(self, teamsApp_id: str) -> TeamsResponse:
        ...
        """
        try:
            response = await self.client.app_catalogs.teams_apps.by_teamsApp_id(
                teamsApp_id
            ).delete()
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def app_catalogs_get_teams_apps(
        self,
        teamsApp_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
    ...
    async def app_catalogs_update_teams_apps(
        self, teamsApp_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def app_catalogs_teams_apps_create_app_definitions(
        self, teamsApp_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Update teamsApp
        ...
        try:
            response = await self.client.app_catalogs.teams_apps.by_teamsApp_id(
                teamsApp_id
            ).app_definitions.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in app_catalogs_teams_apps_create_app_definitions: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def app_catalogs_teams_apps_delete_app_definitions(
        ...
        try:
            response = (
                await self.client.app_catalogs.teams_apps.by_teamsApp_id(teamsApp_id)
                .app_definitions.by_appDefinition_id(teamsAppDefinition_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in app_catalogs_teams_apps_delete_app_definitions: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def app_catalogs_teams_apps_get_app_definitions(
        self,
        teamsApp_id: str,
    ...
    async def app_catalogs_teams_apps_app_definitions_delete_bot(
        self, teamsApp_id: str, teamsAppDefinition_id: str
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in app_catalogs_teams_apps_app_definitions_delete_bot: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def app_catalogs_teams_apps_app_definitions_get_bot(
        self,
        teamsApp_id: str,
        teamsAppDefinition_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            response = (
                await self.client.app_catalogs.teams_apps.by_teamsApp_id(teamsApp_id)
                .app_definitions.by_appDefinition_id(teamsAppDefinition_id)
                .bot.get(request_configuration=config)
            )
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in app_catalogs_teams_apps_app_definitions_get_bot: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def app_catalogs_teams_apps_app_definitions_update_bot(
        self,
        teamsApp_id: str,
        teamsAppDefinition_id: str,
        body: dict[str, Any] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in app_catalogs_teams_apps_app_definitions_update_bot: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def contracts_contract_check_member_objects(
        self, contract_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        """
        try:
            response = await self.client.contracts.by_contract_id(
                contract_id
            ).check_member_objects.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in contracts_contract_check_member_objects: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def directory_deleted_items_directory_object_check_member_objects(
        self, directoryObject_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action checkMemberObjects
        ...
        """
        try:
            response = await self.client.directory.deleted_items.by_deletedItem_id(
                directoryObject_id
            ).check_member_objects.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in directory_deleted_items_directory_object_check_member_objects: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def directory_role_templates_directory_role_template_check_member_objects(
        self, directoryRoleTemplate_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action checkMemberObjects
        ...
        try:
            response = (
                await self.client.directory_role_templates.by_directoryRoleTemplate_id(
                    directoryRoleTemplate_id
                ).check_member_objects.post(body=body)
            )
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in directory_role_templates_directory_role_template_check_member_objects: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def directory_roles_directory_role_check_member_objects(
        self, directoryRole_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action checkMemberObjects
        ...
        """
        try:
            response = await self.client.directory_roles.by_directoryRole_id(
                directoryRole_id
            ).check_member_objects.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in directory_roles_directory_role_check_member_objects: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def directory_roles_get_members_as_group(
        self,
        ...
        try:
            ...
            if skip:
                query_params.skip = skip
            config = MembersRequestBuilder.MembersRequestBuilderGetRequestConfiguration(
                query_parameters=query_params
            )
            response = (
                await self.client.directory_roles.by_directoryRole_id(directoryRole_id)
                .members.by_membership_id(directoryObject_id)
                .graph_group.get(request_configuration=config)
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def directory_roles_get_members_as_service_principal(
        self,
        directoryRole_id: str,
        directoryObject_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            response = (
                await self.client.directory_roles.by_directoryRole_id(directoryRole_id)
                .members.by_membership_id(directoryObject_id)
                .graph_service_principal.get(request_configuration=config)
            )
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in directory_roles_get_members_as_service_principal: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def directory_roles_get_members_as_user(
        self,
        directoryRole_id: str,
        directoryObject_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            response = (
                await self.client.directory_roles.by_directoryRole_id(directoryRole_id)
                .members.by_membership_id(directoryObject_id)
                .graph_user.get(request_configuration=config)
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def directory_roles_create_scoped_members(
        self, directoryRole_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.directory_roles.by_directoryRole_id(
                directoryRole_id
            ).scoped_members.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in directory_roles_create_scoped_members: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def directory_roles_delete_scoped_members(
        self, directoryRole_id: str, scopedRoleMembership_id: str
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.directory_roles.by_directoryRole_id(directoryRole_id)
                .scoped_members.by_scopedMember_id(scopedRoleMembership_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def directory_roles_update_scoped_members(
        self,
        directoryRole_id: str,
    ...
    async def education_classes_create_ref_members(
        self, educationClass_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Add a student
        ...
        """
        try:
            response = await self.client.education.classes.by_classe_id(
                educationClass_id
            ).members.dollar_ref.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in education_classes_create_ref_members: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def education_classes_delete_ref_members(
        self, educationClass_id: str
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.education.classes.by_classe_id(
                educationClass_id
            ).members.dollar_ref.delete()
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in education_classes_delete_ref_members: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def education_classes_members_delete_ref_education_user(
        self, educationClass_id: str, educationUser_id: str
    ) -> TeamsResponse:
        """Remove member from educationClass
        ...
        try:
            response = (
                await self.client.education.classes.by_classe_id(educationClass_id)
                .members.by_membership_id(educationUser_id)
                .dollar_ref.delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in education_classes_members_delete_ref_education_user: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def group_setting_templates_group_setting_template_check_member_objects(
        self, groupSettingTemplate_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action checkMemberObjects
        ...
        try:
            response = (
                await self.client.group_setting_templates.by_groupSettingTemplate_id(
            ...
            logger.error(
                f"Error in group_setting_templates_group_setting_template_check_member_objects: {e}"
            )
            return TeamsResponse(success=False, error=str(e))
    ...
    async def groups_get_member_of(
        self,
        group_id: str,
        directoryObject_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            response = (
                await self.client.groups.by_group_id(group_id)
                .member_of.by_memberOf_id(directoryObject_id)
                .get(request_configuration=config)
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_members_delete_ref_directory_object(
        self, group_id: str, directoryObject_id: str
    ) -> TeamsResponse:
        """Remove member
    ...
    async def groups_get_members_as_group(
        self,
        group_id: str,
        directoryObject_id: str,
        select: list[str] | None = None,
    ...
    async def groups_get_members_as_service_principal(
        self,
        group_id: str,
        directoryObject_id: str,
        select: list[str] | None = None,
    ...
    async def groups_get_members_with_license_errors_as_group(
        self,
        group_id: str,
        directoryObject_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            response = (
                await self.client.groups.by_group_id(group_id)
                .members_with_license_errors.by_membersWithLicenseError_id(
                    directoryObject_id
                )
                .graph_group.get(request_configuration=config)
            )
            ...
            logger.error(
                f"Error in groups_get_members_with_license_errors_as_group: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_get_members_with_license_errors_as_service_principal(
        self,
        group_id: str,
        directoryObject_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in groups_get_members_with_license_errors_as_service_principal: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_get_members_with_license_errors_as_user(
        self,
        group_id: str,
        directoryObject_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in groups_get_members_with_license_errors_as_user: {e}"
            )
            return TeamsResponse(success=False, error=str(e))
    ...
    async def groups_get_team(
        ...
        try:
            ...
            if skip:
                query_params.skip = skip
            config = RequestConfiguration(query_parameters=query_params)
            response = await self.client.groups.by_group_id(group_id).team.get(
                request_configuration=config
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_set_team(
        ...
        """
        try:
            response = await self.client.groups.by_group_id(group_id).team.put(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_team_create_channels(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.channels.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in groups_team_create_channels: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_delete_channels(
    ...
    async def groups_team_update_channels(
        self, group_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def groups_team_channels_create_all_members(
        self, group_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def groups_group_team_channels_channel_all_members_add(
        self, group_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
        ...
        try:
            ...
            logger.error(
                f"Error in groups_group_team_channels_channel_all_members_add: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_group_team_channels_channel_all_members_remove(
        self, group_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
        ...
        try:
            ...
            logger.error(
                f"Error in groups_group_team_channels_channel_all_members_remove: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_channels_delete_all_members(
    ...
    async def groups_team_channels_update_all_members(
        self,
        group_id: str,
        channel_id: str,
        conversationMember_id: str,
    ...
    async def groups_team_channels_create_members(
        self, group_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def groups_group_team_channels_channel_members_add(
        self, group_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
        ...
        try:
            ...
            logger.error(
                f"Error in groups_group_team_channels_channel_members_add: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_group_team_channels_channel_members_remove(
        self, group_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
        ...
        try:
            ...
            logger.error(
                f"Error in groups_group_team_channels_channel_members_remove: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_channels_delete_members(
        self, group_id: str, channel_id: str, conversationMember_id: str
    ) -> TeamsResponse:
    ...
    async def groups_team_channels_get_members(
        self,
        group_id: str,
        channel_id: str,
        conversationMember_id: str,
    ...
    async def groups_team_channels_update_members(
        self,
        group_id: str,
        channel_id: str,
        conversationMember_id: str,
    ...
    async def groups_group_team_channels_channel_provision_email(
        self, group_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action provisionEmail
        ...
        try:
            ...
            logger.error(
                f"Error in groups_group_team_channels_channel_provision_email: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_group_team_channels_channel_remove_email(
        self, group_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action removeEmail
        ...
        try:
            ...
            logger.error(
                f"Error in groups_group_team_channels_channel_remove_email: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_get_group(
        self,
        group_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            if skip:
                query_params.skip = skip
            config = RequestConfiguration(query_parameters=query_params)
            response = await self.client.groups.by_group_id(group_id).team.group.get(
                request_configuration=config
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_team_create_installed_apps(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.installed_apps.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in groups_team_create_installed_apps: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_delete_installed_apps(
        ...
        try:
            response = (
                await self.client.groups.by_group_id(group_id)
                .team.installed_apps.by_installed_app_id(teamsAppInstallation_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_team_get_installed_apps(
        self,
        group_id: str,
        teamsAppInstallation_id: str,
        select: list[str] | None = None,
    ...
    async def groups_team_update_installed_apps(
        self,
        group_id: str,
        teamsAppInstallation_id: str,
        body: dict[str, Any] | None = None,
    ...
    async def groups_team_installed_apps_get_teams_app(
        self,
        group_id: str,
        teamsAppInstallation_id: str,
        select: list[str] | None = None,
    ...
    async def groups_team_installed_apps_get_teams_app_definition(
        self,
        group_id: str,
        teamsAppInstallation_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in groups_team_installed_apps_get_teams_app_definition: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_group_team_installed_apps_teams_app_installation_upgrade(
        self,
        group_id: str,
        teamsAppInstallation_id: str,
        body: dict[str, Any] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in groups_group_team_installed_apps_teams_app_installation_upgrade: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_create_members(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create new navigation property to members for groups
        ...
        """
        try:
            response = await self.client.groups.by_group_id(group_id).team.members.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_group_team_members_add(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.members.add.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in groups_group_team_members_add: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def groups_group_team_members_remove(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.members.remove.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in groups_group_team_members_remove: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_delete_members(
        ...
        try:
            response = (
                await self.client.groups.by_group_id(group_id)
                .team.members.by_membership_id(conversationMember_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_team_get_members(
        self,
        group_id: str,
        conversationMember_id: str,
        select: list[str] | None = None,
    ...
    async def groups_team_update_members(
        self,
        group_id: str,
        conversationMember_id: str,
        body: dict[str, Any] | None = None,
    ...
    async def groups_team_create_operations(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.operations.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in groups_team_create_operations: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_delete_operations(
        self, group_id: str, teamsAsyncOperation_id: str
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.groups.by_group_id(group_id)
                .team.operations.by_operation_id(teamsAsyncOperation_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_team_get_operations(
        self,
        group_id: str,
        teamsAsyncOperation_id: str,
        select: list[str] | None = None,
    ...
    async def groups_team_update_operations(
        self,
        group_id: str,
        teamsAsyncOperation_id: str,
        body: dict[str, Any] | None = None,
    ...
    async def groups_team_get_photo(
        self,
        group_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            if skip:
                query_params.skip = skip
            config = RequestConfiguration(query_parameters=query_params)
            response = await self.client.groups.by_group_id(group_id).team.photo.get(
                request_configuration=config
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_team_update_photo(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        """
        try:
            response = await self.client.groups.by_group_id(group_id).team.photo.patch(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_team_delete_primary_channel(self, group_id: str) -> TeamsResponse:
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.primary_channel.delete()
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in groups_team_delete_primary_channel: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_get_primary_channel(
        self,
        group_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            response = await self.client.groups.by_group_id(
                group_id
            ).team.primary_channel.get(request_configuration=config)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in groups_team_get_primary_channel: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_update_primary_channel(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.primary_channel.patch(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in groups_team_update_primary_channel: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_primary_channel_create_all_members(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create new navigation property to allMembers for groups
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.primary_channel.all_members.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in groups_team_primary_channel_create_all_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_group_team_primary_channel_all_members_add(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.primary_channel.all_members.add.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in groups_group_team_primary_channel_all_members_add: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_group_team_primary_channel_all_members_remove(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.primary_channel.all_members.remove.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in groups_group_team_primary_channel_all_members_remove: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_primary_channel_delete_all_members(
        self, group_id: str, conversationMember_id: str
    ) -> TeamsResponse:
        """Delete navigation property allMembers for groups
        ...
        try:
            response = (
                await self.client.groups.by_group_id(group_id)
                .team.primary_channel.all_members.by_allMember_id(conversationMember_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in groups_team_primary_channel_delete_all_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_primary_channel_update_all_members(
        self,
        group_id: str,
        conversationMember_id: str,
        body: dict[str, Any] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in groups_team_primary_channel_update_all_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))
    ...
    async def groups_team_primary_channel_create_members(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create new navigation property to members for groups
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.primary_channel.members.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in groups_team_primary_channel_create_members: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def groups_group_team_primary_channel_members_add(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.primary_channel.members.add.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in groups_group_team_primary_channel_members_add: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def groups_group_team_primary_channel_members_remove(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.primary_channel.members.remove.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in groups_group_team_primary_channel_members_remove: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_primary_channel_delete_members(
        self, group_id: str, conversationMember_id: str
    ) -> TeamsResponse:
        """Delete navigation property members for groups
        ...
        try:
            response = (
                await self.client.groups.by_group_id(group_id)
                .team.primary_channel.members.by_membership_id(conversationMember_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_team_primary_channel_get_members(
        self,
        group_id: str,
        conversationMember_id: str,
        select: list[str] | None = None,
    ...
    async def groups_team_primary_channel_update_members(
        self,
        group_id: str,
        conversationMember_id: str,
        body: dict[str, Any] | None = None,
    ...
    async def groups_group_team_primary_channel_provision_email(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action provisionEmail
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.primary_channel.provision_email.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in groups_group_team_primary_channel_provision_email: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_group_team_primary_channel_remove_email(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action removeEmail
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.primary_channel.remove_email.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in groups_group_team_primary_channel_remove_email: {e}"
            )
            return TeamsResponse(success=False, error=str(e))
    ...
    async def groups_team_get_schedule(
        self,
        group_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            if skip:
                query_params.skip = skip
            config = RequestConfiguration(query_parameters=query_params)
            response = await self.client.groups.by_group_id(group_id).team.schedule.get(
                request_configuration=config
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_team_set_schedule(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        """
        try:
            response = await self.client.groups.by_group_id(group_id).team.schedule.put(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_team_schedule_create_day_notes(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.schedule.day_notes.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in groups_team_schedule_create_day_notes: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_schedule_delete_day_notes(
        self, group_id: str, dayNote_id: str
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.groups.by_group_id(group_id)
                .team.schedule.day_notes.by_dayNote_id(dayNote_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_team_schedule_get_day_notes(
        self,
        group_id: str,
        dayNote_id: str,
        select: list[str] | None = None,
    ...
    async def groups_team_schedule_update_day_notes(
        self, group_id: str, dayNote_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def groups_team_schedule_create_offer_shift_requests(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.schedule.offer_shift_requests.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in groups_team_schedule_create_offer_shift_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_schedule_delete_offer_shift_requests(
        ...
        try:
            response = (
                await self.client.groups.by_group_id(group_id)
                .team.schedule.offer_shift_requests.by_offerShiftRequest_id(
                    offerShiftRequest_id
                )
                .delete()
            )
            ...
            logger.error(
                f"Error in groups_team_schedule_delete_offer_shift_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_schedule_get_offer_shift_requests(
        self,
        group_id: str,
        offerShiftRequest_id: str,
        select: list[str] | None = None,
    ...
    async def groups_team_schedule_update_offer_shift_requests(
        self,
        group_id: str,
        offerShiftRequest_id: str,
        body: dict[str, Any] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in groups_team_schedule_update_offer_shift_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_schedule_create_open_shift_change_requests(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.schedule.open_shift_change_requests.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in groups_team_schedule_create_open_shift_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_schedule_delete_open_shift_change_requests(
        ...
        try:
            response = (
                await self.client.groups.by_group_id(group_id)
                .team.schedule.open_shift_change_requests.by_openShiftChangeRequest_id(
                    openShiftChangeRequest_id
                )
                .delete()
            )
            ...
            logger.error(
                f"Error in groups_team_schedule_delete_open_shift_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_schedule_get_open_shift_change_requests(
        self,
        group_id: str,
        openShiftChangeRequest_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in groups_team_schedule_get_open_shift_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_schedule_update_open_shift_change_requests(
        self,
        group_id: str,
        openShiftChangeRequest_id: str,
        body: dict[str, Any] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in groups_team_schedule_update_open_shift_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_schedule_create_open_shifts(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.schedule.open_shifts.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in groups_team_schedule_create_open_shifts: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_schedule_delete_open_shifts(
        self, group_id: str, openShift_id: str
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.groups.by_group_id(group_id)
                .team.schedule.open_shifts.by_openShift_id(openShift_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_team_schedule_get_open_shifts(
        self,
        group_id: str,
        openShift_id: str,
        select: list[str] | None = None,
    ...
    async def groups_team_schedule_update_open_shifts(
        self, group_id: str, openShift_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def groups_team_schedule_create_scheduling_groups(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.schedule.scheduling_groups.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in groups_team_schedule_create_scheduling_groups: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_schedule_delete_scheduling_groups(
        ...
        try:
            response = (
                await self.client.groups.by_group_id(group_id)
                .team.schedule.scheduling_groups.by_schedulingGroup_id(
                    schedulingGroup_id
                )
                .delete()
            )
    ...
    async def groups_team_schedule_get_scheduling_groups(
        self,
        group_id: str,
        schedulingGroup_id: str,
        select: list[str] | None = None,
    ...
    async def groups_team_schedule_update_scheduling_groups(
        self, group_id: str, schedulingGroup_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def groups_team_schedule_create_shifts(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.schedule.shifts.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in groups_team_schedule_create_shifts: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_schedule_delete_shifts(
        self, group_id: str, shift_id: str
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.groups.by_group_id(group_id)
                .team.schedule.shifts.by_shift_id(shift_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_team_schedule_get_shifts(
        self,
        group_id: str,
        shift_id: str,
        select: list[str] | None = None,
    ...
    async def groups_team_schedule_update_shifts(
        self, group_id: str, shift_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def groups_team_schedule_create_swap_shifts_change_requests(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.schedule.swap_shifts_change_requests.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in groups_team_schedule_create_swap_shifts_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_schedule_delete_swap_shifts_change_requests(
        ...
        try:
            response = (
                await self.client.groups.by_group_id(group_id)
                .team.schedule.swap_shifts_change_requests.by_swapShiftsChangeRequest_id(
                    swapShiftsChangeRequest_id
                )
                .delete()
            )
            ...
            logger.error(
                f"Error in groups_team_schedule_delete_swap_shifts_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_schedule_get_swap_shifts_change_requests(
        self,
        group_id: str,
        swapShiftsChangeRequest_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in groups_team_schedule_get_swap_shifts_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_schedule_update_swap_shifts_change_requests(
        self,
        group_id: str,
        swapShiftsChangeRequest_id: str,
        body: dict[str, Any] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in groups_team_schedule_update_swap_shifts_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_schedule_create_time_cards(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.schedule.time_cards.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in groups_team_schedule_create_time_cards: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def groups_group_team_schedule_time_cards_clock_in(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action clockIn
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.schedule.time_cards.clock_in.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in groups_group_team_schedule_time_cards_clock_in: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_schedule_delete_time_cards(
        self, group_id: str, timeCard_id: str
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.groups.by_group_id(group_id)
                .team.schedule.time_cards.by_timeCard_id(timeCard_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_team_schedule_get_time_cards(
        self,
        group_id: str,
        timeCard_id: str,
        select: list[str] | None = None,
    ...
    async def groups_team_schedule_update_time_cards(
        self, group_id: str, timeCard_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def groups_group_team_schedule_time_cards_time_card_clock_out(
        self, group_id: str, timeCard_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action clockOut
        ...
        try:
            ...
            logger.error(
                f"Error in groups_group_team_schedule_time_cards_time_card_clock_out: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_group_team_schedule_time_cards_time_card_confirm(
        self, group_id: str, timeCard_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action confirm
        ...
        try:
            ...
            logger.error(
                f"Error in groups_group_team_schedule_time_cards_time_card_confirm: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_group_team_schedule_time_cards_time_card_end_break(
        self, group_id: str, timeCard_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action endBreak
        ...
        try:
            ...
            logger.error(
                f"Error in groups_group_team_schedule_time_cards_time_card_end_break: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_group_team_schedule_time_cards_time_card_start_break(
        self, group_id: str, timeCard_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action startBreak
        ...
        try:
            ...
            logger.error(
                f"Error in groups_group_team_schedule_time_cards_time_card_start_break: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_schedule_create_time_off_reasons(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.schedule.time_off_reasons.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in groups_team_schedule_create_time_off_reasons: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_schedule_delete_time_off_reasons(
        self, group_id: str, timeOffReason_id: str
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.groups.by_group_id(group_id)
                .team.schedule.time_off_reasons.by_timeOffReason_id(timeOffReason_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_team_schedule_get_time_off_reasons(
        self,
        group_id: str,
        timeOffReason_id: str,
        select: list[str] | None = None,
    ...
    async def groups_team_schedule_update_time_off_reasons(
        self, group_id: str, timeOffReason_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def groups_team_schedule_create_time_off_requests(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.schedule.time_off_requests.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in groups_team_schedule_create_time_off_requests: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_schedule_delete_time_off_requests(
        ...
        try:
            response = (
                await self.client.groups.by_group_id(group_id)
                .team.schedule.time_off_requests.by_timeOffRequest_id(timeOffRequest_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_team_schedule_get_time_off_requests(
        self,
        group_id: str,
        timeOffRequest_id: str,
        select: list[str] | None = None,
    ...
    async def groups_team_schedule_update_time_off_requests(
        self, group_id: str, timeOffRequest_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def groups_team_schedule_create_times_off(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.schedule.times_off.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in groups_team_schedule_create_times_off: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_schedule_delete_times_off(
        self, group_id: str, timeOff_id: str
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.groups.by_group_id(group_id)
                .team.schedule.times_off.by_timesOff_id(timeOff_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_team_schedule_get_times_off(
        self,
        group_id: str,
        timeOff_id: str,
        select: list[str] | None = None,
    ...
    async def groups_team_schedule_update_times_off(
        self, group_id: str, timeOff_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def groups_group_team_send_activity_notification(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action sendActivityNotification
        ...
        try:
            response = await self.client.groups.by_group_id(
                group_id
            ).team.send_activity_notification.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in groups_group_team_send_activity_notification: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def groups_team_create_tags(
        self, group_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        """
        try:
            response = await self.client.groups.by_group_id(group_id).team.tags.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_team_delete_tags(
        self, group_id: str, teamworkTag_id: str
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.groups.by_group_id(group_id)
                .team.tags.by_tag_id(teamworkTag_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_team_get_tags(
        self,
        group_id: str,
        teamworkTag_id: str,
        select: list[str] | None = None,
    ...
    async def groups_team_update_tags(
        self, group_id: str, teamworkTag_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def groups_team_tags_create_members(
        self, group_id: str, teamworkTag_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create new navigation property to members for groups
    ...
    async def groups_team_tags_delete_members(
    ...
    async def groups_team_tags_get_members(
        self,
        group_id: str,
        teamworkTag_id: str,
        teamworkTagMember_id: str,
    ...
    async def groups_team_tags_update_members(
        self,
        group_id: str,
        teamworkTag_id: str,
        teamworkTagMember_id: str,
    ...
    async def groups_team_get_template(
        self,
        group_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            if skip:
                query_params.skip = skip
            config = RequestConfiguration(query_parameters=query_params)
            response = await self.client.groups.by_group_id(group_id).team.template.get(
                request_configuration=config
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_get_transitive_member_of(
        self,
        group_id: str,
        directoryObject_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            response = (
                await self.client.groups.by_group_id(group_id)
                .transitive_member_of.by_transitiveMemberOf_id(directoryObject_id)
                .get(request_configuration=config)
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_get_transitive_member_of_as_group(
        self,
        group_id: str,
        directoryObject_id: str,
        select: list[str] | None = None,
    ...
    async def groups_get_transitive_members(
        self,
        group_id: str,
        directoryObject_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            response = (
                await self.client.groups.by_group_id(group_id)
                .transitive_members.by_transitiveMember_id(directoryObject_id)
                .get(request_configuration=config)
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def groups_get_transitive_members_as_service_principal(
        self,
        group_id: str,
        directoryObject_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in groups_get_transitive_members_as_service_principal: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_create_joined_teams(
        self, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_get_joined_teams(
        ...
        try:
            ...
            if skip:
                query_params.skip = skip
            config = RequestConfiguration(query_parameters=query_params)
            response = await self.client.me.joined_teams.by_joinedTeam_id(team_id).get(
                request_configuration=config
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def me_update_joined_teams(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_create_channels(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_delete_channels(
        self, team_id: str, channel_id: str
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_update_channels(
        self, team_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_channels_create_all_members(
        self, team_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_team_channels_channel_all_members_add(
        self, team_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_team_channels_channel_all_members_add: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_team_channels_channel_all_members_remove(
        self, team_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_team_channels_channel_all_members_remove: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_channels_delete_all_members(
        self, team_id: str, channel_id: str, conversationMember_id: str
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_channels_update_all_members(
        self,
        team_id: str,
        channel_id: str,
        conversationMember_id: str,
    ...
    async def me_joined_teams_channels_create_members(
        self, team_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create new navigation property to members for me
    ...
    async def me_joined_teams_team_channels_channel_members_add(
        self, team_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_team_channels_channel_members_add: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_team_channels_channel_members_remove(
        self, team_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_team_channels_channel_members_remove: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_channels_delete_members(
        self, team_id: str, channel_id: str, conversationMember_id: str
    ) -> TeamsResponse:
        """Delete navigation property members for me
    ...
    async def me_joined_teams_channels_get_members(
        self,
        team_id: str,
        channel_id: str,
        conversationMember_id: str,
    ...
    async def me_joined_teams_channels_update_members(
        self,
        team_id: str,
        channel_id: str,
        conversationMember_id: str,
    ...
    async def me_joined_teams_team_channels_channel_provision_email(
        self, team_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action provisionEmail
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_team_channels_channel_provision_email: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_team_channels_channel_remove_email(
        self, team_id: str, channel_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action removeEmail
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_team_channels_channel_remove_email: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_get_group(
        self,
        team_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            response = await self.client.me.joined_teams.by_joinedTeam_id(
                team_id
            ).group.get(request_configuration=config)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in me_joined_teams_get_group: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_create_installed_apps(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create new navigation property to installedApps for me
    ...
    async def me_joined_teams_delete_installed_apps(
        self, team_id: str, teamsAppInstallation_id: str
    ) -> TeamsResponse:
        """Delete navigation property installedApps for me
    ...
    async def me_joined_teams_get_installed_apps(
        self,
        team_id: str,
        teamsAppInstallation_id: str,
        select: list[str] | None = None,
    ...
    async def me_joined_teams_update_installed_apps(
        self,
        team_id: str,
        teamsAppInstallation_id: str,
        body: dict[str, Any] | None = None,
    ...
    async def me_joined_teams_installed_apps_get_teams_app(
        self,
        team_id: str,
        teamsAppInstallation_id: str,
        select: list[str] | None = None,
    ...
    async def me_joined_teams_installed_apps_get_teams_app_definition(
        self,
        team_id: str,
        teamsAppInstallation_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_installed_apps_get_teams_app_definition: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_team_installed_apps_teams_app_installation_upgrade(
        self,
        team_id: str,
        teamsAppInstallation_id: str,
        body: dict[str, Any] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_team_installed_apps_teams_app_installation_upgrade: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_create_members(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create new navigation property to members for me
    ...
    async def me_joined_teams_team_members_add(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
    ...
    async def me_joined_teams_team_members_remove(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
    ...
    async def me_joined_teams_delete_members(
        self, team_id: str, conversationMember_id: str
    ) -> TeamsResponse:
        """Delete navigation property members for me
    ...
    async def me_joined_teams_get_members(
        self,
        team_id: str,
        conversationMember_id: str,
        select: list[str] | None = None,
    ...
    async def me_joined_teams_update_members(
        self,
        team_id: str,
        conversationMember_id: str,
        body: dict[str, Any] | None = None,
    ...
    async def me_joined_teams_create_operations(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.me.joined_teams.by_joinedTeam_id(
                team_id
            ).operations.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in me_joined_teams_create_operations: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_delete_operations(
        self, team_id: str, teamsAsyncOperation_id: str
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_get_operations(
        self,
        team_id: str,
        teamsAsyncOperation_id: str,
        select: list[str] | None = None,
    ...
    async def me_joined_teams_update_operations(
        self,
        team_id: str,
        teamsAsyncOperation_id: str,
        body: dict[str, Any] | None = None,
    ...
    async def me_joined_teams_get_photo(
        self,
        team_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            response = await self.client.me.joined_teams.by_joinedTeam_id(
                team_id
            ).photo.get(request_configuration=config)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in me_joined_teams_get_photo: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_update_photo(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.me.joined_teams.by_joinedTeam_id(
                team_id
            ).photo.patch(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in me_joined_teams_update_photo: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_delete_primary_channel(
        self, team_id: str
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_get_primary_channel(
        self,
        team_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            response = await self.client.me.joined_teams.by_joinedTeam_id(
                team_id
            ).primary_channel.get(request_configuration=config)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in me_joined_teams_get_primary_channel: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_update_primary_channel(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_primary_channel_create_all_members(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create new navigation property to allMembers for me
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_primary_channel_create_all_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_team_primary_channel_all_members_add(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_team_primary_channel_all_members_add: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_team_primary_channel_all_members_remove(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_team_primary_channel_all_members_remove: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_primary_channel_delete_all_members(
        self, team_id: str, conversationMember_id: str
    ) -> TeamsResponse:
        """Delete navigation property allMembers for me
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_primary_channel_delete_all_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_primary_channel_update_all_members(
        self,
        team_id: str,
        conversationMember_id: str,
        body: dict[str, Any] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_primary_channel_update_all_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))
    ...
    async def me_joined_teams_primary_channel_get_files_folder(
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_primary_channel_get_files_folder: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_primary_channel_create_members(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create new navigation property to members for me
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_primary_channel_create_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_team_primary_channel_members_add(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_team_primary_channel_members_add: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_team_primary_channel_members_remove(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_team_primary_channel_members_remove: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_primary_channel_delete_members(
        self, team_id: str, conversationMember_id: str
    ) -> TeamsResponse:
        """Delete navigation property members for me
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_primary_channel_delete_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_primary_channel_get_members(
        self,
        team_id: str,
        conversationMember_id: str,
        select: list[str] | None = None,
    ...
    async def me_joined_teams_primary_channel_update_members(
        self,
        team_id: str,
        conversationMember_id: str,
        body: dict[str, Any] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_primary_channel_update_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_team_primary_channel_provision_email(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action provisionEmail
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_team_primary_channel_provision_email: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_team_primary_channel_remove_email(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action removeEmail
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_team_primary_channel_remove_email: {e}"
            )
            return TeamsResponse(success=False, error=str(e))
    ...
    async def me_joined_teams_get_schedule(
        self,
        team_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            response = await self.client.me.joined_teams.by_joinedTeam_id(
                team_id
            ).schedule.get(request_configuration=config)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in me_joined_teams_get_schedule: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_set_schedule(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_schedule_create_day_notes(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_schedule_delete_day_notes(
        self, team_id: str, dayNote_id: str
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_schedule_get_day_notes(
        self,
        team_id: str,
        dayNote_id: str,
        select: list[str] | None = None,
    ...
    async def me_joined_teams_schedule_update_day_notes(
        self, team_id: str, dayNote_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_schedule_create_offer_shift_requests(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_create_offer_shift_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_delete_offer_shift_requests(
        self, team_id: str, offerShiftRequest_id: str
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_delete_offer_shift_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_get_offer_shift_requests(
        self,
        team_id: str,
        offerShiftRequest_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_get_offer_shift_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_update_offer_shift_requests(
        self,
        team_id: str,
        offerShiftRequest_id: str,
        body: dict[str, Any] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_update_offer_shift_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_create_open_shift_change_requests(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_create_open_shift_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_delete_open_shift_change_requests(
        self, team_id: str, openShiftChangeRequest_id: str
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_delete_open_shift_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_get_open_shift_change_requests(
        self,
        team_id: str,
        openShiftChangeRequest_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_get_open_shift_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_update_open_shift_change_requests(
        self,
        team_id: str,
        openShiftChangeRequest_id: str,
        body: dict[str, Any] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_update_open_shift_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_create_open_shifts(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_schedule_delete_open_shifts(
        self, team_id: str, openShift_id: str
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_schedule_get_open_shifts(
        self,
        team_id: str,
        openShift_id: str,
        select: list[str] | None = None,
    ...
    async def me_joined_teams_schedule_update_open_shifts(
        self, team_id: str, openShift_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_schedule_create_scheduling_groups(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_create_scheduling_groups: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_delete_scheduling_groups(
        self, team_id: str, schedulingGroup_id: str
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_delete_scheduling_groups: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_get_scheduling_groups(
        self,
        team_id: str,
        schedulingGroup_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_get_scheduling_groups: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_update_scheduling_groups(
        self, team_id: str, schedulingGroup_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_update_scheduling_groups: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_create_shifts(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            response = await self.client.me.joined_teams.by_joinedTeam_id(
                team_id
            ).schedule.shifts.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in me_joined_teams_schedule_create_shifts: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_delete_shifts(
        self, team_id: str, shift_id: str
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_schedule_get_shifts(
        self,
        team_id: str,
        shift_id: str,
        select: list[str] | None = None,
    ...
    async def me_joined_teams_schedule_update_shifts(
        self, team_id: str, shift_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_schedule_create_swap_shifts_change_requests(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_create_swap_shifts_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_delete_swap_shifts_change_requests(
        self, team_id: str, swapShiftsChangeRequest_id: str
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_delete_swap_shifts_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_get_swap_shifts_change_requests(
        self,
        team_id: str,
        swapShiftsChangeRequest_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_get_swap_shifts_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_update_swap_shifts_change_requests(
        self,
        team_id: str,
        swapShiftsChangeRequest_id: str,
        body: dict[str, Any] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_update_swap_shifts_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_create_time_cards(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_team_schedule_time_cards_clock_in(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action clockIn
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_team_schedule_time_cards_clock_in: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_delete_time_cards(
        self, team_id: str, timeCard_id: str
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_schedule_get_time_cards(
        self,
        team_id: str,
        timeCard_id: str,
        select: list[str] | None = None,
    ...
    async def me_joined_teams_schedule_update_time_cards(
        self, team_id: str, timeCard_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_team_schedule_time_cards_time_card_clock_out(
        self, team_id: str, timeCard_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action clockOut
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_team_schedule_time_cards_time_card_clock_out: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_team_schedule_time_cards_time_card_confirm(
        self, team_id: str, timeCard_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action confirm
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_team_schedule_time_cards_time_card_confirm: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_team_schedule_time_cards_time_card_end_break(
        self, team_id: str, timeCard_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action endBreak
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_team_schedule_time_cards_time_card_end_break: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_team_schedule_time_cards_time_card_start_break(
        self, team_id: str, timeCard_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action startBreak
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_team_schedule_time_cards_time_card_start_break: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_create_time_off_reasons(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_create_time_off_reasons: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_delete_time_off_reasons(
        self, team_id: str, timeOffReason_id: str
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_delete_time_off_reasons: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_get_time_off_reasons(
        self,
        team_id: str,
        timeOffReason_id: str,
        select: list[str] | None = None,
    ...
    async def me_joined_teams_schedule_update_time_off_reasons(
        self, team_id: str, timeOffReason_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_update_time_off_reasons: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_create_time_off_requests(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_create_time_off_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_delete_time_off_requests(
        self, team_id: str, timeOffRequest_id: str
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_delete_time_off_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_get_time_off_requests(
        self,
        team_id: str,
        timeOffRequest_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_get_time_off_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_update_time_off_requests(
        self, team_id: str, timeOffRequest_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_schedule_update_time_off_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_schedule_create_times_off(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_schedule_delete_times_off(
        self, team_id: str, timeOff_id: str
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_schedule_get_times_off(
        self,
        team_id: str,
        timeOff_id: str,
        select: list[str] | None = None,
    ...
    async def me_joined_teams_schedule_update_times_off(
        self, team_id: str, timeOff_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_team_send_activity_notification(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action sendActivityNotification
        ...
        try:
            ...
            logger.error(
                f"Error in me_joined_teams_team_send_activity_notification: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_joined_teams_create_tags(
        self, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_delete_tags(
        self, team_id: str, teamworkTag_id: str
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_get_tags(
        self,
        team_id: str,
        teamworkTag_id: str,
        select: list[str] | None = None,
    ...
    async def me_joined_teams_update_tags(
        self, team_id: str, teamworkTag_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_joined_teams_tags_create_members(
        self, team_id: str, teamworkTag_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create new navigation property to members for me
    ...
    async def me_joined_teams_tags_delete_members(
        self, team_id: str, teamworkTag_id: str, teamworkTagMember_id: str
    ) -> TeamsResponse:
        """Delete navigation property members for me
    ...
    async def me_joined_teams_tags_get_members(
        self,
        team_id: str,
        teamworkTag_id: str,
        teamworkTagMember_id: str,
    ...
    async def me_joined_teams_tags_update_members(
        self,
        team_id: str,
        teamworkTag_id: str,
        teamworkTagMember_id: str,
    ...
    async def me_joined_teams_get_template(
        self,
        team_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            response = await self.client.me.joined_teams.by_joinedTeam_id(
                team_id
            ).template.get(request_configuration=config)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in me_joined_teams_get_template: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def me_license_details_get_teams_licensing_details(
        self,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        filter: str | None = None,
        ...
        try:
            ...
            config = RequestConfiguration(query_parameters=query_params)
            response = (
                await self.client.me.license_details.get_teams_licensing_details.get(
                    request_configuration=config
                )
            )
            return self._handle_teams_response(response)
            ...
            logger.error(
                f"Error in me_license_details_get_teams_licensing_details: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def me_get_member_of(
        self,
        directoryObject_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            if skip:
                query_params.skip = skip
            config = RequestConfiguration(query_parameters=query_params)
            response = await self.client.me.member_of.by_memberOf_id(
                directoryObject_id
            ).get(request_configuration=config)
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def me_get_member_of_as_directory_role(
        self,
        directoryObject_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            response = await self.client.me.member_of.by_memberOf_id(
                directoryObject_id
            ).graph_directory_role.get(request_configuration=config)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(f"Error in me_get_member_of_as_directory_role: {e}")
            return TeamsResponse(success=False, error=str(e))

    async def me_get_member_of_as_group(
        self,
        directoryObject_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
    ...
    async def me_delete_scoped_role_member_of(
        self, scopedRoleMembership_id: str
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.me.scoped_role_member_of.by_scopedRoleMemberOf_id(
                    scopedRoleMembership_id
                ).delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def me_update_scoped_role_member_of(
        self, scopedRoleMembership_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def me_get_transitive_member_of(
        self,
        directoryObject_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            config = RequestConfiguration(query_parameters=query_params)
            response = (
                await self.client.me.transitive_member_of.by_transitiveMemberOf_id(
                    directoryObject_id
                ).get(request_configuration=config)
            )
            return self._handle_teams_response(response)
    ...
    async def me_get_transitive_member_of_as_directory_role(
        self,
        directoryObject_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
    ...
    async def me_get_transitive_member_of_as_group(
        self,
        directoryObject_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
    ...
    async def organization_organization_check_member_objects(
        self, organization_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action checkMemberObjects
        ...
        """
        try:
            response = await self.client.organization.by_organization_id(
                organization_id
            ).check_member_objects.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in organization_organization_check_member_objects: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def privacy_subject_rights_requests_get_team(
        self,
        ...
        try:
            ...
            if skip:
                query_params.skip = skip
            config = RequestConfiguration(query_parameters=query_params)
            response = await self.client.privacy.subject_rights_requests.by_subjectRightsRequest_id(
    ...
    async def reports_get_teams_team_activity_detail_391d(
        self,
        date: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            config = RequestConfiguration(query_parameters=query_params)
            response = (
                await self.client.reports.get_teams_team_activity_detail_date_date.get(
                    request_configuration=config
                )
            )
            return self._handle_teams_response(response)
    ...
    async def reports_get_teams_team_activity_detail_ee18(
        self,
        period: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            if skip:
                query_params.skip = skip
            config = RequestConfiguration(query_parameters=query_params)
            response = await self.client.reports.get_teams_team_activity_detail_period_period.get(
                request_configuration=config
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def reports_get_teams_user_activity_user_detail_fba7(
        self,
        date: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            if skip:
                query_params.skip = skip
            config = RequestConfiguration(query_parameters=query_params)
            response = await self.client.reports.get_teams_user_activity_user_detail_date_date.get(
                request_configuration=config
            )
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in reports_get_teams_user_activity_user_detail_fba7: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def reports_get_teams_user_activity_user_detail_7554(
        self,
        period: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            if skip:
                query_params.skip = skip
            config = RequestConfiguration(query_parameters=query_params)
            response = await self.client.reports.get_teams_user_activity_user_detail_period_period.get(
                request_configuration=config
            )
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in reports_get_teams_user_activity_user_detail_7554: {e}"
            )
            return TeamsResponse(success=False, error=str(e))
    ...
    async def scoped_role_memberships_scoped_role_membership_create_scoped_role_membership(
        ...
        try:
            ...
            logger.error(
                f"Error in scoped_role_memberships_scoped_role_membership_create_scoped_role_membership: {e}"
            )
            return TeamsResponse(success=False, error=str(e))
    ...
    async def scoped_role_memberships_scoped_role_membership_delete_scoped_role_membership(
        ...
        try:
            response = (
                await self.client.scoped_role_memberships.by_scopedRoleMembership_id(
                    scopedRoleMembership_id
                ).delete()
            )
            return self._handle_teams_response(response)
            ...
            logger.error(
                f"Error in scoped_role_memberships_scoped_role_membership_delete_scoped_role_membership: {e}"
            )
            return TeamsResponse(success=False, error=str(e))
    ...
    async def scoped_role_memberships_scoped_role_membership_get_scoped_role_membership(
        ...
        try:
            ...
            logger.error(
                f"Error in scoped_role_memberships_scoped_role_membership_get_scoped_role_membership: {e}"
            )
            return TeamsResponse(success=False, error=str(e))
    ...
    async def scoped_role_memberships_scoped_role_membership_update_scoped_role_membership(
        ...
        try:
            ...
            logger.error(
                f"Error in scoped_role_memberships_scoped_role_membership_update_scoped_role_membership: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teams_team_create_team(
        self, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create team
    ...
    async def teams_templates_teams_template_create_teams_template(
        self, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in teams_templates_teams_template_create_teams_template: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teams_templates_teams_template_delete_teams_template(
        self, teamsTemplate_id: str
    ) -> TeamsResponse:
        ...
        """
        try:
            response = await self.client.teams_templates.by_teamsTemplate_id(
                teamsTemplate_id
            ).delete()
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in teams_templates_teams_template_delete_teams_template: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teams_templates_teams_template_get_teams_template(
        self,
        ...
        try:
            ...
            logger.error(
                f"Error in teams_templates_teams_template_get_teams_template: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def teams_templates_teams_template_update_teams_template(
        self, teamsTemplate_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in teams_templates_teams_template_update_teams_template: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def tenant_relationships_multi_tenant_organization_delete_tenants(
        self, multiTenantOrganizationMember_id: str
    ) -> TeamsResponse:
        ...
        """
        try:
            response = await self.client.tenant_relationships.multi_tenant_organization.tenants.by_tenant_id(
                multiTenantOrganizationMember_id
            ).delete()
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in tenant_relationships_multi_tenant_organization_delete_tenants: {e}"
            )
            return TeamsResponse(success=False, error=str(e))
    ...
    async def tenant_relationships_multi_tenant_organization_get_tenants(
        ...
        try:
            ...
            logger.error(
                f"Error in tenant_relationships_multi_tenant_organization_get_tenants: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def tenant_relationships_multi_tenant_organization_update_tenants(
        self, multiTenantOrganizationMember_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in tenant_relationships_multi_tenant_organization_update_tenants: {e}"
            )
            return TeamsResponse(success=False, error=str(e))
    ...
    async def users_create_joined_teams(
        self, user_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        """
        try:
            response = await self.client.users.by_user_id(user_id).joined_teams.post(
                body=body
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def users_delete_joined_teams(
    ...
    async def users_get_joined_teams(
        self,
        user_id: str,
        team_id: str,
        select: list[str] | None = None,
    ...
    async def users_update_joined_teams(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def users_joined_teams_create_channels(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def users_joined_teams_delete_channels(
    ...
    async def users_joined_teams_update_channels(
        self,
        user_id: str,
        team_id: str,
        channel_id: str,
    ...
    async def users_joined_teams_channels_create_all_members(
        self,
        user_id: str,
        team_id: str,
        channel_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_channels_create_all_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_user_joined_teams_team_channels_channel_all_members_add(
        self,
        user_id: str,
        team_id: str,
        channel_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_joined_teams_team_channels_channel_all_members_add: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_user_joined_teams_team_channels_channel_all_members_remove(
        self,
        user_id: str,
        team_id: str,
        channel_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_joined_teams_team_channels_channel_all_members_remove: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_channels_delete_all_members(
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_channels_delete_all_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_channels_update_all_members(
        self,
        user_id: str,
        team_id: str,
        channel_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_channels_update_all_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))
    ...
    async def users_joined_teams_channels_create_members(
        self,
        user_id: str,
        team_id: str,
        channel_id: str,
    ...
    async def users_user_joined_teams_team_channels_channel_members_add(
        self,
        user_id: str,
        team_id: str,
        channel_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_joined_teams_team_channels_channel_members_add: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_user_joined_teams_team_channels_channel_members_remove(
        self,
        user_id: str,
        team_id: str,
        channel_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_joined_teams_team_channels_channel_members_remove: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_channels_delete_members(
        self, user_id: str, team_id: str, channel_id: str, conversationMember_id: str
    ) -> TeamsResponse:
        """Delete navigation property members for users
    ...
    async def users_joined_teams_channels_get_members(
        self,
        user_id: str,
        team_id: str,
        channel_id: str,
    ...
    async def users_joined_teams_channels_update_members(
        self,
        user_id: str,
        team_id: str,
        channel_id: str,
    ...
    async def users_user_joined_teams_team_channels_channel_provision_email(
        self,
        user_id: str,
        team_id: str,
        channel_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_joined_teams_team_channels_channel_provision_email: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_user_joined_teams_team_channels_channel_remove_email(
        self,
        user_id: str,
        team_id: str,
        channel_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_joined_teams_team_channels_channel_remove_email: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_get_group(
        self,
        user_id: str,
        team_id: str,
        select: list[str] | None = None,
    ...
    async def users_joined_teams_create_installed_apps(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create new navigation property to installedApps for users
    ...
    async def users_joined_teams_delete_installed_apps(
    ...
    async def users_joined_teams_get_installed_apps(
        self,
        user_id: str,
        team_id: str,
        teamsAppInstallation_id: str,
    ...
    async def users_joined_teams_update_installed_apps(
        self,
        user_id: str,
        team_id: str,
        teamsAppInstallation_id: str,
    ...
    async def users_joined_teams_installed_apps_get_teams_app(
        self,
        user_id: str,
        team_id: str,
        teamsAppInstallation_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_installed_apps_get_teams_app: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_installed_apps_get_teams_app_definition(
        self,
        user_id: str,
        team_id: str,
        teamsAppInstallation_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_installed_apps_get_teams_app_definition: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_user_joined_teams_team_installed_apps_teams_app_installation_upgrade(
        self,
        user_id: str,
        team_id: str,
        teamsAppInstallation_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_joined_teams_team_installed_apps_teams_app_installation_upgrade: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_create_members(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create new navigation property to members for users
    ...
    async def users_user_joined_teams_team_members_add(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
    ...
    async def users_user_joined_teams_team_members_remove(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
    ...
    async def users_joined_teams_delete_members(
    ...
    async def users_joined_teams_get_members(
        self,
        user_id: str,
        team_id: str,
        conversationMember_id: str,
    ...
    async def users_joined_teams_update_members(
        self,
        user_id: str,
        team_id: str,
        conversationMember_id: str,
    ...
    async def users_joined_teams_create_operations(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def users_joined_teams_delete_operations(
    ...
    async def users_joined_teams_get_operations(
        self,
        user_id: str,
        team_id: str,
        teamsAsyncOperation_id: str,
    ...
    async def users_joined_teams_update_operations(
        self,
        user_id: str,
        team_id: str,
        teamsAsyncOperation_id: str,
    ...
    async def users_joined_teams_get_photo(
        self,
        user_id: str,
        team_id: str,
        select: list[str] | None = None,
    ...
    async def users_joined_teams_update_photo(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def users_joined_teams_delete_primary_channel(
        self, user_id: str, team_id: str
    ) -> TeamsResponse:
    ...
    async def users_joined_teams_get_primary_channel(
        self,
        user_id: str,
        team_id: str,
        select: list[str] | None = None,
    ...
    async def users_joined_teams_update_primary_channel(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def users_joined_teams_primary_channel_create_all_members(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create new navigation property to allMembers for users
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_primary_channel_create_all_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_user_joined_teams_team_primary_channel_all_members_add(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_joined_teams_team_primary_channel_all_members_add: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_user_joined_teams_team_primary_channel_all_members_remove(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_joined_teams_team_primary_channel_all_members_remove: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_primary_channel_delete_all_members(
        self, user_id: str, team_id: str, conversationMember_id: str
    ) -> TeamsResponse:
        """Delete navigation property allMembers for users
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_primary_channel_delete_all_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_primary_channel_update_all_members(
        self,
        user_id: str,
        team_id: str,
        conversationMember_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_primary_channel_update_all_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))
    ...
    async def users_joined_teams_primary_channel_get_files_folder(
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_primary_channel_get_files_folder: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_primary_channel_create_members(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Create new navigation property to members for users
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_primary_channel_create_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_user_joined_teams_team_primary_channel_members_add(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action add
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_joined_teams_team_primary_channel_members_add: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_user_joined_teams_team_primary_channel_members_remove(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action remove
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_joined_teams_team_primary_channel_members_remove: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_primary_channel_delete_members(
        self, user_id: str, team_id: str, conversationMember_id: str
    ) -> TeamsResponse:
        """Delete navigation property members for users
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_primary_channel_delete_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_primary_channel_get_members(
        self,
        user_id: str,
        team_id: str,
        conversationMember_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_primary_channel_get_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_primary_channel_update_members(
        self,
        user_id: str,
        team_id: str,
        conversationMember_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_primary_channel_update_members: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_user_joined_teams_team_primary_channel_provision_email(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action provisionEmail
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_joined_teams_team_primary_channel_provision_email: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_user_joined_teams_team_primary_channel_remove_email(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action removeEmail
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_joined_teams_team_primary_channel_remove_email: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_delete_schedule(
        self, user_id: str, team_id: str
    ) -> TeamsResponse:
    ...
    async def users_joined_teams_get_schedule(
        self,
        user_id: str,
        team_id: str,
        select: list[str] | None = None,
    ...
    async def users_joined_teams_set_schedule(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def users_joined_teams_schedule_create_day_notes(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def users_joined_teams_schedule_delete_day_notes(
    ...
    async def users_joined_teams_schedule_get_day_notes(
        self,
        user_id: str,
        team_id: str,
        dayNote_id: str,
    ...
    async def users_joined_teams_schedule_update_day_notes(
        self,
        user_id: str,
        team_id: str,
        dayNote_id: str,
    ...
    async def users_joined_teams_schedule_create_offer_shift_requests(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_create_offer_shift_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_delete_offer_shift_requests(
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_delete_offer_shift_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_get_offer_shift_requests(
        self,
        user_id: str,
        team_id: str,
        offerShiftRequest_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_get_offer_shift_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_update_offer_shift_requests(
        self,
        user_id: str,
        team_id: str,
        offerShiftRequest_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_update_offer_shift_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_create_open_shift_change_requests(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_create_open_shift_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_delete_open_shift_change_requests(
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_delete_open_shift_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_get_open_shift_change_requests(
        self,
        user_id: str,
        team_id: str,
        openShiftChangeRequest_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_get_open_shift_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_update_open_shift_change_requests(
        self,
        user_id: str,
        team_id: str,
        openShiftChangeRequest_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_update_open_shift_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_create_open_shifts(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_create_open_shifts: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_delete_open_shifts(
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_delete_open_shifts: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_get_open_shifts(
        self,
        user_id: str,
        team_id: str,
        openShift_id: str,
    ...
    async def users_joined_teams_schedule_update_open_shifts(
        self,
        user_id: str,
        team_id: str,
        openShift_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_update_open_shifts: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_create_scheduling_groups(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_create_scheduling_groups: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_delete_scheduling_groups(
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_delete_scheduling_groups: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_get_scheduling_groups(
        self,
        user_id: str,
        team_id: str,
        schedulingGroup_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_get_scheduling_groups: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_update_scheduling_groups(
        self,
        user_id: str,
        team_id: str,
        schedulingGroup_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_update_scheduling_groups: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_create_shifts(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def users_joined_teams_schedule_delete_shifts(
        self, user_id: str, team_id: str, shift_id: str
    ) -> TeamsResponse:
    ...
    async def users_joined_teams_schedule_get_shifts(
        self,
        user_id: str,
        team_id: str,
        shift_id: str,
    ...
    async def users_joined_teams_schedule_update_shifts(
        self,
        user_id: str,
        team_id: str,
        shift_id: str,
    ...
    async def users_joined_teams_schedule_create_swap_shifts_change_requests(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_create_swap_shifts_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_delete_swap_shifts_change_requests(
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_delete_swap_shifts_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_get_swap_shifts_change_requests(
        self,
        user_id: str,
        team_id: str,
        swapShiftsChangeRequest_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_get_swap_shifts_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_update_swap_shifts_change_requests(
        self,
        user_id: str,
        team_id: str,
        swapShiftsChangeRequest_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_update_swap_shifts_change_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_create_time_cards(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def users_user_joined_teams_team_schedule_time_cards_clock_in(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action clockIn
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_joined_teams_team_schedule_time_cards_clock_in: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_delete_time_cards(
    ...
    async def users_joined_teams_schedule_get_time_cards(
        self,
        user_id: str,
        team_id: str,
        timeCard_id: str,
    ...
    async def users_joined_teams_schedule_update_time_cards(
        self,
        user_id: str,
        team_id: str,
        timeCard_id: str,
    ...
    async def users_user_joined_teams_team_schedule_time_cards_time_card_clock_out(
        self,
        user_id: str,
        team_id: str,
        timeCard_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_joined_teams_team_schedule_time_cards_time_card_clock_out: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_user_joined_teams_team_schedule_time_cards_time_card_confirm(
        self,
        user_id: str,
        team_id: str,
        timeCard_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_joined_teams_team_schedule_time_cards_time_card_confirm: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_user_joined_teams_team_schedule_time_cards_time_card_end_break(
        self,
        user_id: str,
        team_id: str,
        timeCard_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_joined_teams_team_schedule_time_cards_time_card_end_break: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_user_joined_teams_team_schedule_time_cards_time_card_start_break(
        self,
        user_id: str,
        team_id: str,
        timeCard_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_joined_teams_team_schedule_time_cards_time_card_start_break: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_create_time_off_reasons(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_create_time_off_reasons: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_delete_time_off_reasons(
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_delete_time_off_reasons: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_get_time_off_reasons(
        self,
        user_id: str,
        team_id: str,
        timeOffReason_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_get_time_off_reasons: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_update_time_off_reasons(
        self,
        user_id: str,
        team_id: str,
        timeOffReason_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_update_time_off_reasons: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_create_time_off_requests(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_create_time_off_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_delete_time_off_requests(
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_delete_time_off_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_get_time_off_requests(
        self,
        user_id: str,
        team_id: str,
        timeOffRequest_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_get_time_off_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_update_time_off_requests(
        self,
        user_id: str,
        team_id: str,
        timeOffRequest_id: str,
        ...
        try:
            ...
            logger.error(
                f"Error in users_joined_teams_schedule_update_time_off_requests: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_schedule_create_times_off(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def users_joined_teams_schedule_delete_times_off(
    ...
    async def users_joined_teams_schedule_get_times_off(
        self,
        user_id: str,
        team_id: str,
        timeOff_id: str,
    ...
    async def users_joined_teams_schedule_update_times_off(
        self,
        user_id: str,
        team_id: str,
        timeOff_id: str,
    ...
    async def users_user_joined_teams_team_send_activity_notification(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
        """Invoke action sendActivityNotification
        ...
        try:
            ...
            logger.error(
                f"Error in users_user_joined_teams_team_send_activity_notification: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_joined_teams_create_tags(
        self, user_id: str, team_id: str, body: dict[str, Any] | None = None
    ) -> TeamsResponse:
    ...
    async def users_joined_teams_delete_tags(
    ...
    async def users_joined_teams_get_tags(
        self,
        user_id: str,
        team_id: str,
        teamworkTag_id: str,
    ...
    async def users_joined_teams_update_tags(
        self,
        user_id: str,
        team_id: str,
        teamworkTag_id: str,
    ...
    async def users_joined_teams_tags_create_members(
        self,
        user_id: str,
        team_id: str,
        teamworkTag_id: str,
    ...
    async def users_joined_teams_tags_delete_members(
    ...
    async def users_joined_teams_tags_get_members(
        self,
        user_id: str,
        team_id: str,
        teamworkTag_id: str,
    ...
    async def users_joined_teams_tags_update_members(
        self,
        user_id: str,
        team_id: str,
        teamworkTag_id: str,
    ...
    async def users_joined_teams_get_template(
        self,
        user_id: str,
        team_id: str,
        select: list[str] | None = None,
    ...
    async def users_user_license_details_get_teams_licensing_details(
        self,
        user_id: str,
        select: list[str] | None = None,
        expand: list[str] | None = None,
        ...
        try:
            ...
            response = await self.client.users.by_user_id(
                user_id
            ).license_details.get_teams_licensing_details.get(
                request_configuration=config
            )
            return self._handle_teams_response(response)
        except Exception as e:
            logger.error(
                f"Error in users_user_license_details_get_teams_licensing_details: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_get_member_of(
        self,
        user_id: str,
        directoryObject_id: str,
        select: list[str] | None = None,
    ...
    async def users_get_member_of_as_directory_role(
        self,
        user_id: str,
        directoryObject_id: str,
        select: list[str] | None = None,
    ...
    async def users_create_scoped_role_member_of(
        ...
        try:
            response = await self.client.users.by_user_id(
                user_id
            ).scoped_role_member_of.post(body=body)
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def users_delete_scoped_role_member_of(
        self, user_id: str, scopedRoleMembership_id: str
    ) -> TeamsResponse:
        ...
        try:
            response = (
                await self.client.users.by_user_id(user_id)
                .scoped_role_member_of.by_scopedRoleMemberOf_id(scopedRoleMembership_id)
                .delete()
            )
            return self._handle_teams_response(response)
        except Exception as e:
    ...
    async def users_get_transitive_member_of(
        self,
        user_id: str,
        directoryObject_id: str,
        select: list[str] | None = None,
    ...
    async def users_get_transitive_member_of_as_directory_role(
        self,
        user_id: str,
        directoryObject_id: str,
        select: list[str] | None = None,
        ...
        try:
            ...
            logger.error(
                f"Error in users_get_transitive_member_of_as_directory_role: {e}"
            )
            return TeamsResponse(success=False, error=str(e))

    async def users_get_transitive_member_of_as_group(
        self,
        user_id: str,
        directoryObject_id: str,
        select: list[str] | None = None,
