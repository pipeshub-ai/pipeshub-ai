...
class HubSpotDataSource:
    ...
    async def get_quote(
        ...
        url = self.base_url + f"/crm/v3/objects/quotes/{quote_id}"
        if query_params:
            query_string = urlencode(query_params)
            url += f"?{query_string}"
    ...
    async def get_call(
        ...
        url = self.base_url + f"/crm/v3/objects/calls/{call_id}"
        if query_params:
            query_string = urlencode(query_params)
            url += f"?{query_string}"
    ...
    async def get_email_activity(
        ...
        url = self.base_url + f"/crm/v3/objects/emails/{email_id}"
        if query_params:
            query_string = urlencode(query_params)
            url += f"?{query_string}"
    ...
    async def get_marketing_email(
        ...
        """
        url = self.base_url + f"/marketing/v3/marketing-emails/{email_id}"
    ...
    async def clone_marketing_email(
        ...
        """
        url = self.base_url + f"/marketing/v3/marketing-emails/{email_id}/clone"
    ...
    async def publish_marketing_email(
        ...
        """
        url = self.base_url + f"/marketing/v3/marketing-emails/{email_id}/publish"
    ...
    async def get_page(
        ...
        url = self.base_url + f"/cms/v3/pages/{page_id}"
        if query_params:
            query_string = urlencode(query_params)
            url += f"?{query_string}"
    ...
    async def publish_page(
        ...
        """
        url = self.base_url + f"/cms/v3/pages/{page_id}/publish"
    ...
    async def unpublish_page(
        ...
        """
        url = self.base_url + f"/cms/v3/pages/{page_id}/unpublish"
    ...
    async def clone_page(
        ...
        """
        url = self.base_url + f"/cms/v3/pages/{page_id}/clone"
    ...
    async def list_webhooks(
        ...
        """
        url = self.base_url + f"/webhooks/v3/{app_id}/subscriptions"
    ...
    async def get_webhook(
        ...
        """
        url = self.base_url + f"/webhooks/v3/{app_id}/subscriptions/{subscription_id}"
    ...
    async def list_properties(
        ...
        url = self.base_url + f"/crm/v3/properties/{object_type}"
        if query_params:
            query_string = urlencode(query_params)
            url += f"?{query_string}"
    ...
    async def get_property(
        ...
        url = self.base_url + f"/crm/v3/properties/{object_type}/{property_name}"
        if query_params:
            query_string = urlencode(query_params)
            url += f"?{query_string}"
    ...
    async def get_form(
        ...
        url = self.base_url + f"/marketing/v3/forms/{form_id}"
        if query_params:
            query_string = urlencode(query_params)
            url += f"?{query_string}"
    ...
    async def create_form(
        ...
        thank_you_message_html: str | None = None,
        captcha_enabled: bool | None = None,
        create_new_contact_for_new_email: bool | None = None,
        pre_populate_known_values: bool | None = None,
        allow_link_to_reset_known_values: bool | None = None,
