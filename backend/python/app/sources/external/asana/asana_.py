...
class AsanaDataSource:
    ...
    client: asana.ApiClient created by your AsanaClientViaToken/OAuth.
    ...
    def add_dependencies_for_task(
        ...
        try:
            with _temporary_headers(self._client, headers):
                return self.tasks.add_dependencies_for_task(body, task_gid)
    ...
    def add_dependents_for_task(
        ...
        try:
            with _temporary_headers(self._client, headers):
                return self.tasks.add_dependents_for_task(body, task_gid)
        except ApiException as e:
    ...
    def add_project_for_task(
        ...
        try:
            with _temporary_headers(self._client, headers):
                return self.tasks.add_project_for_task(body, task_gid)
        except ApiException as e:
    ...
    def remove_dependencies_for_task(
        ...
        try:
            with _temporary_headers(self._client, headers):
                return self.tasks.remove_dependencies_for_task(body, task_gid)
        except ApiException as e:
    ...
    def remove_dependents_for_task(
        ...
        try:
            with _temporary_headers(self._client, headers):
                return self.tasks.remove_dependents_for_task(body, task_gid)
        except ApiException as e:
    ...
    def remove_project_for_task(
        ...
        try:
            with _temporary_headers(self._client, headers):
                return self.tasks.remove_project_for_task(body, task_gid)
        except ApiException as e:
    ...
    def remove_tag_for_task(
        ...
        try:
            with _temporary_headers(self._client, headers):
                return self.tasks.remove_tag_for_task(body, task_gid)
        except ApiException as e:
    ...
    def create_story_for_task(
        ...
        try:
            with _temporary_headers(self._client, headers):
                return self.stories.create_story_for_task(body, task_gid, _clean_opts(opts))
        except ApiException as e:
    ...
    def update_story(
        self, body: Dict, story_gid: str, opts: Optional[Dict] = None, headers: Optional[Dict[str, str]] = None
    ):
        try:
            with _temporary_headers(self._client, headers):
                return self.stories.update_story(body, story_gid, _clean_opts(opts))
        except ApiException as e:
    ...
    def get_workspaces(self, opts: Optional[Dict] = None, headers: Optional[Dict[str, str]] = None):
        try:
            with _temporary_headers(self._client, headers):
                return self.workspaces.get_workspaces(_clean_opts(opts))
        except ApiException as e:
            raise RuntimeError(f"get_workspaces failed: {e}")

    def update_workspace(
        self, body: Dict, workspace_gid: str, opts: Optional[Dict] = None, headers: Optional[Dict[str, str]] = None
    ):
        try:
            with _temporary_headers(self._client, headers):
                return self.workspaces.update_workspace(body, workspace_gid, _clean_opts(opts))
        except ApiException as e:
    ...
    def create_section_for_project(
        ...
        try:
            with _temporary_headers(self._client, headers):
                return self.sections.create_section_for_project(project_gid, _clean_opts(opts))
        except ApiException as e:
    ...
    def update_section(
        self, section_gid: str, opts: Optional[Dict] = None, headers: Optional[Dict[str, str]] = None
    ):
        try:
            with _temporary_headers(self._client, headers):
                return self.sections.update_section(section_gid, _clean_opts(opts))
        except ApiException as e:
    ...
    def update_tag(
        self, body: Dict, tag_gid: str, opts: Optional[Dict] = None, headers: Optional[Dict[str, str]] = None
    ):
        try:
            with _temporary_headers(self._client, headers):
                return self.tags.update_tag(body, tag_gid, _clean_opts(opts))
        except ApiException as e:
