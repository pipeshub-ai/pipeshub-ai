...
def call_api(endpoint: str, token: str, method: str = "GET", data: dict | None = None, headers_override: dict | None = None) -> dict:
...
def test_ugc_post_creation(token: str, user_id: str, asset_id: str | None = None) -> str | None:
