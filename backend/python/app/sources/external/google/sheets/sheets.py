...
class GoogleSheetsDataSource:
    ...
    async def spreadsheets_values_batch_get_by_data_filter(
        ...
        if "body" in kwargs:
            body = kwargs.pop("body")
            request = self.client.spreadsheets_values().batchGetByDataFilter(
                **kwargs, body=body
            )  # type: ignore
        else:
    ...
    async def spreadsheets_values_batch_update_by_data_filter(
        ...
        if "body" in kwargs:
            body = kwargs.pop("body")
            request = self.client.spreadsheets_values().batchUpdateByDataFilter(
                **kwargs, body=body
            )  # type: ignore
        else:
            request = self.client.spreadsheets_values().batchUpdateByDataFilter(
    ...
    async def spreadsheets_values_batch_clear_by_data_filter(
        ...
        if "body" in kwargs:
            body = kwargs.pop("body")
            request = self.client.spreadsheets_values().batchClearByDataFilter(
                **kwargs, body=body
            )  # type: ignore
        else:
    ...
    async def spreadsheets_developer_metadata_search(
        ...
        if "body" in kwargs:
            body = kwargs.pop("body")
            request = self.client.spreadsheets_developerMetadata().search(
                **kwargs, body=body
            )  # type: ignore
        else:
