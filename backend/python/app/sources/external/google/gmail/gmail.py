...
class GoogleGmailDataSource:
    ...
    async def users_drafts_list(
        ...
        q: str | None = None,
        includeSpamTrash: bool | None = None,
        **kwargs,
    ) -> dict[str, Any]:
    ...
    async def users_messages_import(
        self,
        userId: str,
        internalDateSource: str | None = None,
        neverMarkSpam: bool | None = None,
        processForCalendar: bool | None = None,
        ...
        **kwargs,
        ...
        if "body" in kwargs:
            body = kwargs.pop("body")
            request = getattr(self.client.users().messages(), "import")(
                **kwargs, body=body
            )  # type: ignore
        else:
    ...
    async def users_settings_update_auto_forwarding(
        ...
        **kwargs,
        ...
        if "body" in kwargs:
            body = kwargs.pop("body")
            request = (
                self.client.users().settings().updateAutoForwarding(**kwargs, body=body)
            )  # type: ignore
        else:
    ...
    async def users_settings_send_as_smime_info_insert(
        ...
        **kwargs,
        ...
        if "body" in kwargs:
            body = kwargs.pop("body")
            request = self.client.users_settings_sendAs_smimeInfo().insert(
                **kwargs, body=body
            )  # type: ignore
        else:
    ...
    async def users_settings_send_as_smime_info_set_default(
        ...
        **kwargs,
        ...
        if "body" in kwargs:
            body = kwargs.pop("body")
            request = self.client.users_settings_sendAs_smimeInfo().setDefault(
                **kwargs, body=body
            )  # type: ignore
        else:
    ...
    async def users_settings_cse_identities_create(
        ...
        **kwargs,
        ...
        if "body" in kwargs:
            body = kwargs.pop("body")
            request = self.client.users_settings_cse_identities().create(
                **kwargs, body=body
            )  # type: ignore
        else:
    ...
    async def users_settings_cse_identities_patch(
        ...
        **kwargs,
        ...
        if "body" in kwargs:
            body = kwargs.pop("body")
            request = self.client.users_settings_cse_identities().patch(
                **kwargs, body=body
            )  # type: ignore
        else:
    ...
    async def users_settings_cse_keypairs_create(
        ...
        **kwargs,
        ...
        if "body" in kwargs:
            body = kwargs.pop("body")
            request = self.client.users_settings_cse_keypairs().create(
                **kwargs, body=body
            )  # type: ignore
        else:
    ...
    async def users_settings_cse_keypairs_disable(
        ...
        **kwargs,
        ...
        if "body" in kwargs:
            body = kwargs.pop("body")
            request = self.client.users_settings_cse_keypairs().disable(
                **kwargs, body=body
            )  # type: ignore
        else:
    ...
    async def users_settings_cse_keypairs_enable(
        ...
        **kwargs,
        ...
        if "body" in kwargs:
            body = kwargs.pop("body")
            request = self.client.users_settings_cse_keypairs().enable(
                **kwargs, body=body
            )  # type: ignore
        else:
    ...
    async def users_settings_cse_keypairs_obliterate(
        ...
        **kwargs,
        ...
        if "body" in kwargs:
            body = kwargs.pop("body")
            request = self.client.users_settings_cse_keypairs().obliterate(
                **kwargs, body=body
            )  # type: ignore
        else:
    ...
    async def users_settings_forwarding_addresses_create(
        ...
        **kwargs,
        ...
        if "body" in kwargs:
            body = kwargs.pop("body")
            request = self.client.users_settings_forwardingAddresses().create(
                **kwargs, body=body
            )  # type: ignore
        else:
