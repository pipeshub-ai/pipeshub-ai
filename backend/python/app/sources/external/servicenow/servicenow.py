...
class ServiceNowDataSource:
    ...
    async def get_globalsearch_search(
        ...
        params = self._build_params(
            sysparm_groups=sysparm_groups,
            sysparm_search=sysparm_search,
        )
    ...
    async def post_identifyreconcile_enhanced(
        ...
        params = self._build_params(
            sysparm_data_source=sysparm_data_source,
            options=options,
        )
    ...
    async def post_migrate_madrid(
        ...
        params = self._build_params(
            sysparm_scope=sysparm_scope,
            sysparm_client_type=sysparm_client_type,
        )
    ...
    async def get_sg_preferences(
        self,
        sysparm_pref_name: str | None = None,
    ) -> ServiceNowResponse:
    ...
    async def get_search_itemlookup(
        self,
        sysparm_table_name: str,
        sysparm_item_sys_id: str,
    ) -> ServiceNowResponse:
    ...
    async def get_search_sources(
        self,
        sysparm_search_context_config_id: str | None = None,
    ) -> ServiceNowResponse:
    ...
    async def get_now_uiextension_name(
        ...
        params = self._build_params(
            sysparm_scope=sysparm_scope,
            sysparm_variables=sysparm_variables,
        )
