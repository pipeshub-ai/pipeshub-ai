    ...
    "get_user": {
        ...
        "parameters": {
            ...
            "opts": {
                ...
                "required": False,
                "description": "Options including opt_fields",
            },
        },
    },
    "get_users": {
        ...
        "parameters": {
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including workspace, team, limit, offset, opt_fields",
            }
        },
    },
    "get_users_for_team": {
        ...
        "parameters": {
            ...
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including offset, opt_fields",
            },
        },
    },
    ...
    "get_favorites_for_user": {
        ...
        "parameters": {
            ...
            "resource_type": {
                "type": "str",
                "required": True,
                "description": "Resource type (project, portfolio, etc.)",
            },
            "workspace": {
                "type": "str",
                "required": True,
            ...
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including limit, offset, opt_fields",
            },
        },
    },
    # ========================================================================
    ...
    "get_tasks": {
        ...
        "parameters": {
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including assignee, project, workspace, limit, offset, opt_fields",
            }
        },
    },
    "get_tasks_for_project": {
        ...
        "parameters": {
            ...
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including completed_since, limit, offset, opt_fields",
            },
        },
    },
    ...
    "get_tasks_for_user_task_list": {
        ...
        "parameters": {
            "user_task_list_gid": {
                "type": "str",
                "required": True,
                "description": "User task list GID",
            },
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
    ...
    "remove_dependents_for_task": {
        ...
        "parameters": {
            "body": {
                "type": "Dict[str, Any]",
                "required": True,
                "description": "Dependents to remove",
            },
            "task_gid": {"type": "str", "required": True, "description": "Task GID"},
        },
    },
    ...
    "remove_follower_for_task": {
        ...
        "parameters": {
            "body": {
                "type": "Dict[str, Any]",
                "required": True,
                "description": "Followers to remove",
            },
            "task_gid": {"type": "str", "required": True, "description": "Task GID"},
            "opts": {
                "type": "Optional[Dict[str, Any]]",
    ...
    "add_project_for_task": {
        ...
        "parameters": {
            "body": {
                "type": "Dict[str, Any]",
                "required": True,
                "description": "Project and insertion details",
            },
            "task_gid": {"type": "str", "required": True, "description": "Task GID"},
        },
    },
    ...
    "duplicate_project": {
        ...
        "parameters": {
            "body": {
                "type": "Dict[str, Any]",
                "required": True,
                "description": "Duplication configuration",
            },
            "project_gid": {
                "type": "str",
                "required": True,
    ...
    "get_projects": {
        ...
        "parameters": {
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including workspace, team, archived, limit, offset, opt_fields",
            }
        },
    },
    "get_projects_for_team": {
        ...
        "parameters": {
            ...
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including archived, limit, offset, opt_fields",
            },
        },
    },
    ...
    "add_custom_field_setting_for_project": {
        ...
        "parameters": {
            "body": {
                "type": "Dict[str, Any]",
                "required": True,
                "description": "Custom field setting",
            },
            "project_gid": {
                "type": "str",
                "required": True,
    ...
    "remove_custom_field_setting_for_project": {
        ...
        "parameters": {
            "body": {
                "type": "Dict[str, Any]",
                "required": True,
                "description": "Custom field to remove",
            },
            "project_gid": {
                "type": "str",
                "required": True,
    ...
    "create_section_for_project": {
        ...
        "parameters": {
            ...
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including body and opt_fields",
            },
        },
    },
    "update_section": {
    ...
    "add_task_for_section": {
        ...
        "parameters": {
            ...
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including body",
            },
        },
    },
    "insert_section_for_project": {
        ...
        "parameters": {
            "body": {
                "type": "Dict[str, Any]",
                "required": True,
                "description": "Section and position",
            },
            "project_gid": {
                "type": "str",
                "required": True,
    ...
    "create_attachment_for_object": {
        ...
        "parameters": {
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including resource_subtype, file, parent, url, name",
            }
        },
    },
    "delete_attachment": {
    ...
    "get_tags": {
        ...
        "parameters": {
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including workspace, limit, offset, opt_fields",
            }
        },
    },
    "get_tags_for_task": {
    ...
    "get_goals": {
        ...
        "parameters": {
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including portfolio, project, task, is_workspace_level, team, workspace, time_periods, limit, offset, opt_fields",
            }
        },
    },
    ...
    "add_supporting_work_for_goal": {
        ...
        "parameters": {
            "body": {
                "type": "Dict[str, Any]",
                "required": True,
                "description": "Supporting work to add",
            },
            "goal_gid": {"type": "str", "required": True, "description": "Goal GID"},
            "opts": {
                "type": "Optional[Dict[str, Any]]",
    ...
    "remove_supporting_work_for_goal": {
        ...
        "parameters": {
            "body": {
                "type": "Dict[str, Any]",
                "required": True,
                "description": "Supporting work to remove",
            },
            "goal_gid": {"type": "str", "required": True, "description": "Goal GID"},
        },
    },
    ...
    "get_statuses_for_object": {
        ...
        "parameters": {
            "parent": {
                "type": "str",
                "required": True,
                "description": "Parent object GID",
            },
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including created_since, limit, offset, opt_fields",
            },
        },
    },
    # ========================================================================
    ...
    "create_project_brief": {
        ...
        "parameters": {
            "body": {
                "type": "Dict[str, Any]",
                "required": True,
                "description": "Project brief data",
            },
            "project_gid": {
                "type": "str",
                "required": True,
    ...
    "update_project_brief": {
        ...
        "parameters": {
            "body": {
                "type": "Dict[str, Any]",
                "required": True,
                "description": "Project brief updates",
            },
            "project_brief_gid": {
                "type": "str",
                "required": True,
    ...
    "get_project_template": {
        ...
        "parameters": {
            "project_template_gid": {
                "type": "str",
                "required": True,
                "description": "Project template GID",
            },
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
    ...
    "get_time_periods": {
        ...
        "parameters": {
            ...
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including start_on, end_on, limit, offset, opt_fields",
            },
        },
    },
    # ========================================================================
    ...
    "update_membership": {
        ...
        "parameters": {
            "body": {
                "type": "Dict[str, Any]",
                "required": True,
                "description": "Membership updates",
            },
            "membership_gid": {
                "type": "str",
                "required": True,
    ...
    "get_memberships": {
        ...
        "parameters": {
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including parent, member, limit, offset, opt_fields",
            }
        },
    },
    # ========================================================================
    ...
    "get_team_memberships": {
        ...
        "parameters": {
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including team, user, workspace, limit, offset, opt_fields",
            }
        },
    },
    ...
    "get_workspace_memberships_for_workspace": {
        ...
        "parameters": {
            ...
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including user, limit, offset, opt_fields",
            },
        },
    },
    # ========================================================================
    ...
    "get_webhooks": {
        ...
        "parameters": {
            ...
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including limit, offset, resource, opt_fields",
            },
        },
    },
    # ========================================================================
    ...
    "get_events": {
        ...
        "parameters": {
            "resource": {
                "type": "str",
                "required": True,
                "description": "Resource GID to watch",
            },
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including sync",
            },
        },
    },
    # ========================================================================
    ...
    "typeahead_for_workspace": {
        ...
        "parameters": {
            ...
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including type, query, count, opt_fields",
            },
        },
    },
    # ========================================================================
    ...
    "get_audit_log_events": {
        ...
        "parameters": {
            ...
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including start_at, end_at, event_type, actor_type, actor_gid, resource_gid, limit, offset",
            },
        },
    },
    # ========================================================================
    ...
    "get_organization_export": {
        ...
        "parameters": {
            "organization_export_gid": {
                "type": "str",
                "required": True,
                "description": "Organization export GID",
            },
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
    ...
    "update_allocation": {
        ...
        "parameters": {
            "body": {
                "type": "Dict[str, Any]",
                "required": True,
                "description": "Allocation updates",
            },
            "allocation_gid": {
                "type": "str",
                "required": True,
    ...
    "get_allocations": {
        ...
        "parameters": {
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including parent, assignee, workspace, limit, offset, opt_fields",
            }
        },
    },
    # ========================================================================
    ...
    "approve_access_request": {
        ...
        "parameters": {
            "access_request_gid": {
                "type": "str",
                "required": True,
                "description": "Access request GID",
            }
        },
    },
    ...
    "get_access_requests": {
        ...
        "parameters": {
            "target": {
                "type": "str",
                "required": True,
                "description": "Target object GID",
            },
            "opts": {
                "type": "Optional[Dict[str, Any]]",
                "required": False,
                "description": "Options including user, opt_fields",
            },
        },
    },
...
def generate_asana_client(output_file: Optional[str] = None) -> str:
    ...
    print(f"\n💡 Usage Example:")
    print(
        f"   from app.sources.client.asana.asana import AsanaClient, AsanaTokenConfig"
    )
