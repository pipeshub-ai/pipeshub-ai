...
BOOKSTACK_API_ENDPOINTS = {
    ...
    "create_attachment": {
        ...
        "parameters": {
            ...
            "uploaded_to": {
                "type": "int",
                "location": "body",
                "description": "ID of the page to attach to",
            },
            "file": {
                "type": "Optional[bytes]",
                "location": "file",
                "description": "File data for file attachments",
            },
            "link": {
                "type": "Optional[str]",
                "location": "body",
    ...
    "create_book": {
        ...
        "parameters": {
            ...
            "default_template_id": {
                "type": "Optional[int]",
                "location": "body",
                "description": "Default template page ID",
            },
        },
        "required": ["name"],
    },
    ...
    "update_chapter": {
        ...
        "parameters": {
            ...
            "book_id": {
                "type": "Optional[int]",
                "location": "body",
                "description": "Parent book ID (to move chapter)",
            },
            "name": {
                "type": "Optional[str]",
                "location": "body",
    ...
    "create_page": {
        ...
        "parameters": {
            "book_id": {
                "type": "Optional[int]",
                "location": "body",
                "description": "Parent book ID (required without chapter_id)",
            },
            "chapter_id": {
                "type": "Optional[int]",
                "location": "body",
                "description": "Parent chapter ID (required without book_id)",
            },
            "name": {"type": "str", "location": "body", "description": "Page name"},
            "html": {
                "type": "Optional[str]",
                "location": "body",
                "description": "HTML content (required without markdown)",
            },
            "markdown": {
                "type": "Optional[str]",
                "location": "body",
                "description": "Markdown content (required without html)",
            },
            "tags": {
                "type": "Optional[List[Dict[str, str]]]",
                "location": "body",
    ...
    "update_page": {
        ...
        "parameters": {
            ...
            "book_id": {
                "type": "Optional[int]",
                "location": "body",
                "description": "Parent book ID (to move page)",
            },
            "chapter_id": {
                "type": "Optional[int]",
                "location": "body",
                "description": "Parent chapter ID (to move page)",
            },
            "name": {
                "type": "Optional[str]",
                "location": "body",
    ...
    "create_image": {
        ...
        "parameters": {
            "type": {
                "type": "str",
                "location": "body",
                "description": "Image type: gallery or drawio",
            },
            "uploaded_to": {
                "type": "int",
                "location": "body",
    ...
    "update_image": {
        ...
        "parameters": {
            ...
            "image": {
                "type": "Optional[bytes]",
                "location": "file",
                "description": "New image file data",
            },
        },
        "required": ["id"],
    },
    ...
    "delete_user": {
        ...
        "parameters": {
            ...
            "migrate_ownership_id": {
                "type": "Optional[int]",
                "location": "body",
                "description": "User ID to migrate content ownership to",
            },
        },
        "required": ["id"],
    },
    ...
    "create_role": {
        ...
        "parameters": {
            ...
            "mfa_enforced": {
                "type": "Optional[bool]",
                "location": "body",
                "description": "Enforce MFA for this role",
            },
            "external_auth_id": {
                "type": "Optional[str]",
                "location": "body",
    ...
    "get_content_permissions": {
        ...
        "parameters": {
            "content_type": {
                "type": "str",
                "location": "path",
                "description": "Content type: page, book, chapter, or bookshelf",
            },
            "content_id": {
                "type": "int",
                "location": "path",
    ...
    "update_content_permissions": {
        ...
        "parameters": {
            ...
            "role_permissions": {
                "type": "Optional[List[Dict[str, Union[int, bool]]]]",
                "location": "body",
                "description": "Role permission overrides",
            },
            "fallback_permissions": {
                "type": "Optional[Dict[str, Union[bool, None]]]",
                "location": "body",
                "description": "Fallback permissions configuration",
            },
        },
        "required": ["content_type", "content_id"],
    },
...
def _generate_method(method_name: str, endpoint_info: Dict) -> str:
    ...
    if parameters:
        ...
        for param in path_params + query_params + body_params + file_params:
            ...
            docstring_lines.append(
                f"            {param['sanitized']}: {param['description']}{req_str}"
            )
    ...
    if query_params:
        ...
        for param in query_params:
            ...
            if param["name"] == "filter" and "Dict" in param["type"]:
                ...
                body_lines.append(
                    f"            for key, value in {param['sanitized']}.items():"
                )
                body_lines.append("                params[f'filter[{key}]'] = value")
            else:
                body_lines.append(f"        if {param['sanitized']} is not None:")
                body_lines.append(
                    f'            params["{param["name"]}"] = {param["sanitized"]}'
                )
    else:
        body_lines.append("        params: Dict[str, Union[str, int]] = {}")
    ...
    if has_body_params or has_file_params:
        ...
        for param in body_params:
            body_lines.append(f"        if {param['sanitized']} is not None:")
            body_lines.append(
                f'            body["{param["name"]}"] = {param["sanitized"]}'
            )
        ...
        if has_file_params:
            ...
            for param in file_params:
                body_lines.append(f"        if {param['sanitized']} is not None:")
                body_lines.append(
                    f'            files["{param["name"]}"] = {param["sanitized"]}'
                )
    ...
    if path_params:
        ...
        body_lines.append(
            f'        url = self.base_url + "{path}".format({format_args})'
        )
    else:
    ...
    body_lines.append(
        "            return BookStackResponse(success=True, data=response)"
    )
