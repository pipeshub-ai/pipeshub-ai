...
class EvernoteAPIDefinition:
    ...
    def get_note_store_methods() -> List[Dict[str, Any]]:
        ...
        return [
            ...
            },
            {
                ...
                "params": ["authenticationToken", "afterUSN", "maxEntries", "filter"],
                "required": ["authenticationToken", "afterUSN", "maxEntries", "filter"],
            },
            {
                "name": "getLinkedNotebookSyncState",
                "params": ["authenticationToken", "linkedNotebook"],
                "required": ["authenticationToken", "linkedNotebook"],
            },
            {
            ...
            {
                "name": "listAccessibleBusinessNotebooks",
                "params": ["authenticationToken"],
                "required": ["authenticationToken"],
            },
            {
                "name": "getNotebook",
                "params": ["authenticationToken", "guid"],
                "required": ["authenticationToken", "guid"],
            },
            {
            ...
            {
                "name": "createNotebook",
                "params": ["authenticationToken", "notebook"],
                "required": ["authenticationToken", "notebook"],
            },
            {
                "name": "updateNotebook",
                "params": ["authenticationToken", "notebook"],
            ...
            {
                "name": "getNoteWithResultSpec",
                "params": ["authenticationToken", "guid", "resultSpec"],
                "required": ["authenticationToken", "guid", "resultSpec"],
            },
            {
            ...
            },
            {
                ...
                "params": ["authenticationToken", "guid", "key"],
                "required": ["authenticationToken", "guid", "key"],
            },
            {
                "name": "setNoteApplicationDataEntry",
                "params": ["authenticationToken", "guid", "key", "value"],
                "required": ["authenticationToken", "guid", "key", "value"],
            },
            {
            ...
            {
                "name": "createNote",
                "params": ["authenticationToken", "note"],
                "required": ["authenticationToken", "note"],
            },
            {
                "name": "updateNote",
                "params": ["authenticationToken", "note"],
            ...
            {
                "name": "copyNote",
                "params": ["authenticationToken", "noteGuid", "toNotebookGuid"],
                "required": ["authenticationToken", "noteGuid", "toNotebookGuid"],
            },
            {
                "name": "listNoteVersions",
                "params": ["authenticationToken", "noteGuid"],
                "required": ["authenticationToken", "noteGuid"],
            },
            {
                "name": "getNoteVersion",
                "params": [
            ...
            {
                "name": "findNotes",
                "params": ["authenticationToken", "filter", "offset", "maxNotes"],
                "required": ["authenticationToken", "filter", "offset", "maxNotes"],
            },
            {
                "name": "findNoteOffset",
                "params": ["authenticationToken", "filter", "guid"],
                "required": ["authenticationToken", "filter", "guid"],
            },
            {
            ...
            {
                "name": "findNoteCounts",
                "params": ["authenticationToken", "filter", "withTrash"],
                "required": ["authenticationToken", "filter", "withTrash"],
            },
            {
                "name": "findRelated",
                "params": ["authenticationToken", "query", "resultSpec"],
                "required": ["authenticationToken", "query", "resultSpec"],
            },
            # Tag Methods
            {
                "name": "listTags",
            ...
            },
            {
                ...
                "params": ["authenticationToken", "notebookGuid"],
                "required": ["authenticationToken", "notebookGuid"],
            },
            {
                "name": "getTag",
                "params": ["authenticationToken", "guid"],
            ...
            {
                "name": "createTag",
                "params": ["authenticationToken", "tag"],
                "required": ["authenticationToken", "tag"],
            },
            {
                "name": "updateTag",
                "params": ["authenticationToken", "tag"],
            ...
            {
                "name": "updateResource",
                "params": ["authenticationToken", "resource"],
                "required": ["authenticationToken", "resource"],
            },
            {
            ...
            {
                "name": "createSearch",
                "params": ["authenticationToken", "search"],
                "required": ["authenticationToken", "search"],
            },
            {
                "name": "updateSearch",
                "params": ["authenticationToken", "search"],
            ...
            # Sharing Methods
            {
                ...
                "params": ["shareKey", "authenticationToken"],
                "required": ["shareKey"],
            },
            {
            ...
            },
            {
                ...
                "params": ["guid", "noteKey", "authenticationToken"],
                "required": ["guid", "noteKey"],
            },
            {
                "name": "shareNote",
                "params": ["authenticationToken", "guid"],
            ...
            {
                "name": "shareNotebook",
                "params": ["authenticationToken", "sharedNotebook", "message"],
                "required": ["authenticationToken", "sharedNotebook"],
            },
            {
                "name": "createOrUpdateNotebookShares",
                "params": ["authenticationToken", "shareTemplate"],
                "required": ["authenticationToken", "shareTemplate"],
            },
            {
                "name": "updateSharedNotebook",
                "params": ["authenticationToken", "sharedNotebook"],
                "required": ["authenticationToken", "sharedNotebook"],
            },
            {
                "name": "setNotebookRecipientSettings",
                "params": ["authenticationToken", "notebookGuid", "recipientSettings"],
                "required": [
                    "authenticationToken",
                    "notebookGuid",
                    "recipientSettings",
            ...
            {
                "name": "getNotebookShares",
                "params": ["authenticationToken", "notebookGuid"],
                "required": ["authenticationToken", "notebookGuid"],
            },
            {
                "name": "manageNotebookShares",
                "params": ["authenticationToken", "parameters"],
                "required": ["authenticationToken", "parameters"],
            },
            {
                "name": "manageNoteShares",
                "params": ["authenticationToken", "parameters"],
                "required": ["authenticationToken", "parameters"],
            },
            # Public/Business Methods
            {
                ...
                "params": ["userId", "publicUri"],
                "required": ["userId", "publicUri"],
            },
            {
                "name": "emailNote",
                "params": ["authenticationToken", "parameters"],
    ...
    def get_user_store_methods() -> List[Dict[str, Any]]:
        ...
        return [
            {
                "name": "checkVersion",
                "params": ["clientName", "edamVersionMajor", "edamVersionMinor"],
                "required": ["clientName"],
            },
            {"name": "getBootstrapInfo", "params": ["locale"], "required": ["locale"]},
            {
                "name": "authenticateLongSession",
                "params": [
                    "username",
                    "password",
                    "consumerKey",
            ...
            {
                "name": "completeTwoFactorAuthentication",
                "params": [
                    "authenticationToken",
                    "oneTimeCode",
                    "deviceIdentifier",
                ...
                "required": ["authenticationToken", "oneTimeCode", "deviceDescription"],
            },
            {
                "name": "revokeLongSession",
                "params": ["authenticationToken"],
                "required": ["authenticationToken"],
            },
            {
                "name": "authenticateToBusiness",
                "params": ["authenticationToken"],
                "required": ["authenticationToken"],
            },
            {
            ...
            {
                "name": "inviteToBusiness",
                "params": ["authenticationToken", "emailAddress"],
                "required": ["authenticationToken", "emailAddress"],
            },
            {
                "name": "removeFromBusiness",
                "params": ["authenticationToken", "emailAddress"],
                "required": ["authenticationToken", "emailAddress"],
            },
            {
                "name": "updateBusinessUserIdentifier",
                "params": ["authenticationToken", "oldEmailAddress", "newEmailAddress"],
                "required": [
                    "authenticationToken",
                    "oldEmailAddress",
                    "newEmailAddress",
            ...
            {
                "name": "listBusinessUsers",
                "params": ["authenticationToken"],
                "required": ["authenticationToken"],
            },
            {
                "name": "listBusinessInvitations",
                "params": ["authenticationToken", "includeRequestedInvitations"],
                "required": ["authenticationToken", "includeRequestedInvitations"],
            },
            {
...
class EvernoteCodeGenerator:
    ...
    def _build_thrift_call(
        self, method_name: str, params: List[str], service: str
    ) -> str:
...
{chr(10).join(args_code)}
    ...
    def _generate_method(self, method_def: Dict[str, Any], service: str) -> str:
        ...
        doc_params = "\n        ".join(
            [
                f"    {self._to_snake_case(p)} ({'required' if p in required else 'optional'}): {p}"
                for p in params
            ]
        )
...
'''
    ...
    def save_to_file(self, filename: Optional[str] = None) -> None:
        ...
        print(
            f"[SUCCESS] Generated Evernote DataSource: {len(self.generated_methods)} methods"
        )
