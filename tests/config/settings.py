...
class APIConfig(BaseModel):
    ...
    base_url: str = Field(default="http://localhost:3000", description="Base API URL")
...
class MongoDBConfig(BaseModel):
    ...
    uri: str = Field(default="mongodb://admin:password@localhost:27017/", description="MongoDB URI")
    database_name: str = Field(default="enterprise-search", description="MongoDB database name")


class ArangoDBConfig(BaseModel):
    """ArangoDB configuration for tests."""
    
    url: str = Field(default="http://localhost:8529", description="ArangoDB URL")
    username: str = Field(default="root", description="ArangoDB username")
    password: str = Field(default="your_password", description="ArangoDB password")
    database_name: str = Field(default="es", description="ArangoDB database name")
