...
# Convenience aliases
generate_user = TestDataFactory.user
generate_organization = TestDataFactory.organization


def generate_users(count: int, **kwargs) -> List[Dict[str, Any]]:
    """Generate multiple users."""
    return TestDataFactory.batch(count, TestDataFactory.user, **kwargs)


def generate_organizations(count: int, **kwargs) -> List[Dict[str, Any]]:
    """Generate multiple organizations."""
    return TestDataFactory.batch(count, TestDataFactory.organization, **kwargs)
