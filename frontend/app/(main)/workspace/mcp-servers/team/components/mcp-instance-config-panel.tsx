...
const TRANSPORT_OPTIONS: { value: McpTransport; label: string }[] = [
  ...
  { value: 'sse', label: MCP_TRANSPORT_LABELS.sse },
    ...
    >
      {mode === 'edit' ? (
        <Tabs.Root
          ...
          style={{ width: '100%' }}
        >
          <Tabs.List style={{ borderBottom: '1px solid var(--olive-3)', marginBottom: 'var(--space-4)' }}>
          ...
          <Tabs.Content value="configuration">{configurationForm}</Tabs.Content>
