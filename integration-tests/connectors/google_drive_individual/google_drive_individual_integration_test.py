...
* ``drive_individual_blocks_connector`` — ``folder_ids=[seed]`` with five sample
  ...
  order 26 TC-DRIVE-IND-BLOCKS-004 — OWASP Test PDF
  order 27 TC-DRIVE-IND-BLOCKS-005 — CONTRIBUTING.md

  order 28-32 TC-DRIVE-IND-IDX-001..005 — same five samples reach indexingStatus
...
for PDF / Docs / Slides; Sheets uses the non-LLM Excel path.
...
_BLOCKS_CASES = [
    ...
    pytest.param(
        "contributing_md",
        "TC-DRIVE-IND-BLOCKS-005",
        marks=pytest.mark.order(27),
        id="TC-DRIVE-IND-BLOCKS-005",
    ),
]
