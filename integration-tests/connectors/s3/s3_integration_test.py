...
class TestS3Connector:
    ...
    def test_tc_incr_001_incremental_sync_new_files(
        ...
        for object_key, file_bytes in new_files.items():
            s3_storage.upload_object(bucket_name, object_key, file_bytes, content_type="text/csv")
    ...
    def test_tc_update_001_content_change_detection(
        ...
        assert post_meta["etag"] != pre_meta["etag"], (
            f"S3 ETag should change after overwrite; "
